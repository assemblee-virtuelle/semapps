  ...
  <Edit title={<OrganizationTitle />} {...props}>
    <SimpleForm>
      ...
      <JsonLdReferenceInput label="Responsables" reference="Person" source="hasResponsible">
        <AutocompleteArrayInput optionText={record => `${record['firstName']} ${record['lastName']}`} fullWidth />
      ...
      <JsonLdReferenceInput label="Intérêts" reference="Thema" source="hasInterest">
        <AutocompleteArrayInput optionText={record => (record && record['label']) || 'LABEL MANQUANT'} fullWidth />
      </JsonLdReferenceInput>
    </SimpleForm>
  </Edit>
);
