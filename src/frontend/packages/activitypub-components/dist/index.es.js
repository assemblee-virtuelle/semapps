...
import { createWsChannel as $85cNH$createWsChannel } from '@semapps/semantic-data-provider/src/notificationChannels/subscribeToUpdates';
...
const $c1e897431d8c5742$var$useItemsFromPagesAndNotifications = (pages, notifications, dereferenceItems) => {
  ...
  const currentItems = !pages
    ? []
    : pages.flatMap(p => (0, $e4e1b14e0441184d$export$e57ff0f701c44363)(p.orderedItems || p.items));
...
const $c1e897431d8c5742$var$useCollection = (predicateOrUrl, options = {}) => {
  ...
  const {
    ...
    errors: itemErrors
  } = $c1e897431d8c5742$var$useItemsFromPagesAndNotifications(data.pages, notifications, dereferenceItems);
  ...
  (0, $85cNH$useEffect)(() => {
    if (liveUpdates)
      ...
      (0, $85cNH$createWsChannel)(dataProvider.fetch, collectionUrl)
        .then(webSocket => {
  ...
  const allErrors = (0, $e4e1b14e0441184d$export$e57ff0f701c44363)(collectionError).concat(
    (0, $e4e1b14e0441184d$export$e57ff0f701c44363)(itemErrors)
  );
  return {
    items: items,
