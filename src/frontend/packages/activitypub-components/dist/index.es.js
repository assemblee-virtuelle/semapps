 ...
 */ const $25cb6caf33e2f460$export$c4cb1062f0ffb837 = async (subjectUri, dataset, shapeTypes, validator) => {
  const validationReport = await validator.validate(
    ...
    {
      dataset: dataset,
      terms: [(0, $85cNH$rdfext).namedNode(subjectUri)]
...
const $8281f3ce3b9d6123$var$useItemsFromPages = (pages, dereferenceItems) => {
  ...
  const items = (0, $85cNH$useMemo)(
    () => pages.flatMap(p => (0, $577f4953dfa5de4f$export$e57ff0f701c44363)(p.orderedItems || p.items)),
    [pages]
  );
      ...
      queryClient.setQueryData(
        ...
        oldData => {
          ...
          if (pages?.[0]?.orderedItems)
            pages[0].orderedItems = [item, ...(0, $577f4953dfa5de4f$export$e57ff0f701c44363)(pages[0].orderedItems)];
          else if (pages?.[0]?.items)
            pages[0].items = [item, ...(0, $577f4953dfa5de4f$export$e57ff0f701c44363)(pages[0].items)];
          oldData.pages = pages;
          return oldData;
        }
      );
...
const $3047004939eff50c$var$PostCommentForm = ({
  context: context,
    ...
    async values => {
      ...
      if (document.body.innerHTML === 'undefined')
        ...
        try {
          ...
          await outbox.post({
            ...note,
            to: [...mentionedUsersUris, (0, $cb5f912aee8137fc$export$4d8d554031975581)]
          });
              ...
              editorOptions: {
                ...
                extensions: [
                  ...
                  placeholder
                    ...
                    : null,
                  mentions
                    ? (0, $40f4c00d51a137ec$export$2e2bcd8739ae039).configure({
                        HTMLAttributes: {
                          class: 'mention'
                        },
                        suggestion: mentions
...
const $a8ae38fbe2f0ecc5$var$CommentsField = ({
  source: source = 'id',
  context: context = 'id',
  helperText: helperText,
...
const $f2bfc37210e303cc$var$CollectionList = ({
  collectionUrl: collectionUrl,
  resource: resource,
  children: children
}) => {
...
const $4d1eaed181ef6aa8$var$ReferenceCollectionField = ({
  source: source,
  reference: reference,
  children: children,
  ...rest
...
const $75609b4dfb738328$var$getFetchCollectionPage =
  ...
  async ({ pageParam: pageUri }) => {
    ...
    const dataset = (0, $85cNH$createConnectedLdoDataset)([(0, $85cNH$solidConnectedPlugin)]);
...
export {
  $a8ae38fbe2f0ecc5$export$2e2bcd8739ae039 as CommentsField,
  $f2bfc37210e303cc$export$2e2bcd8739ae039 as CollectionList,
  $4d1eaed181ef6aa8$export$2e2bcd8739ae039 as ReferenceCollectionField,
  ...
  $d33ef82068985aa5$export$2e2bcd8739ae039 as useWebfinger,
  $2444c190214b72ec$export$2e2bcd8739ae039 as useMentions,
  $cb5f912aee8137fc$export$1ec8e53e7d982d22 as ACTIVITY_TYPES,
  $cb5f912aee8137fc$export$9649665d7ccb0dc2 as ACTOR_TYPES,
  $cb5f912aee8137fc$export$c49cfb2681596b20 as OBJECT_TYPES,
  $cb5f912aee8137fc$export$4d8d554031975581 as PUBLIC_URI
};
