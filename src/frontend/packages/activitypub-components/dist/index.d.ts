...
import { ap, a7, aG, au, aP, av, ax } from '@tanstack/query-core/build/legacy/hydration-BCnR_RAv';
...
export const useCollection: (
  ...
  | {
      ...
      refetch: (options?: ap | undefined) => Promise<aG<a7<any, unknown>, Error>>;
      fetchNextPage: (options?: au | undefined) => Promise<aP<a7<any, unknown>, Error>>;
