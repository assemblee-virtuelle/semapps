...
import { RefetchOptions, InfiniteData, QueryObserverResult, FetchNextPageOptions, InfiniteQueryObserverResult, FetchPreviousPageOptions, FetchStatus } from "@tanstack/react-query";
import { RefetchOptions as _RefetchOptions1, InfiniteData as _InfiniteData1, QueryObserverResult as _QueryObserverResult1, FetchNextPageOptions as _FetchNextPageOptions1, InfiniteQueryObserverResult as _InfiniteQueryObserverResult1 } from "@tanstack/query-core";
 ...
 */
export const useCollection: (predicateOrUrl: string, options?: UseCollectionOptions) => {
    items: any[];
...
export const useOutbox: (options?: UseCollectionOptions) => {
    ...
    fetchNextPage: (options?: _FetchNextPageOptions1) => Promise<_InfiniteQueryObserverResult1<_InfiniteData1<any, unknown>, Error>>;
    addItem: (item: string | any, shouldRefetch?: boolean | number) => void;
    removeItem: (item: string | any, shouldRefetch?: boolean) => void;
    hasNextPage: boolean;
    isLoading: boolean;
 ...
 */
export const useTypedCollection: <ItemType extends LdoBase>(collectionUri: string, options: UseCollectionOptions & UseTypedCollectionOptions<ItemType>) => {
    items: ItemType[];
    liveUpdatesStatus: {
        error?: any;
    ...
    fetchPreviousPage: (options?: FetchPreviousPageOptions) => Promise<InfiniteQueryObserverResult<InfiniteData<{
        itemIds: never[];
        dataset: null;
        data: null;
        pageUri?: undefined;
    ...
    isStale: boolean;
    isEnabled: boolean;
    refetch: (options?: RefetchOptions) => Promise<QueryObserverResult<InfiniteData<{
        itemIds: never[];
        dataset: null;
        data: null;
        pageUri?: undefined;
