 ...
 */ const $5ca5f7e9fc1c3544$var$useCollection = (predicateOrUrl, options = {})=>{
    ...
    const fetchCollection = (0, $583VT$react.useCallback)(async ({ pageParam: nextPageUrl })=>{
        ...
        if (shaclShapeUri !== '' && json[itemsKey] && json[itemsKey].length > 0) try {
            ...
            const validatedResults = await (0, $24b34de916fb30a8$export$1558e55ae3912bbb)((0, $03510abb28fd3d8a$export$e57ff0f701c44363)(json[itemsKey]), shaclValidator, context);
