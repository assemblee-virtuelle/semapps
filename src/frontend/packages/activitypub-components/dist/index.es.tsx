 ...
 */ const $25cb6caf33e2f460$export$c4cb1062f0ffb837 = async (subjectUri: any, dataset: any, shapeTypes: any, validator: any)=>{
...
const $8281f3ce3b9d6123$var$useItemsFromPages = (pages: any, dereferenceItems: any)=>{
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const items = (0, $85cNH$useMemo)(()=>pages.flatMap((p: any) => (0, $577f4953dfa5de4f$export$e57ff0f701c44363)(p.orderedItems || p.items)), [
        pages
    ]);
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const itemQueries = (0, $85cNH$useQueries)(!shouldDereference ? $8281f3ce3b9d6123$var$emptyArray : items.filter((item: any) => typeof item === 'string').map((itemUri: any) => ({
        queryKey: [
            'resource',
            itemUri
        ],
 ...
 */ const $8281f3ce3b9d6123$var$useCollection = (predicateOrUrl: any, options = {})=>{
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const addItem = (0, $85cNH$useCallback)((item: any, shouldRefetch = true)=>{
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const removeItem = (0, $85cNH$useCallback)((item: any, shouldRefetch = true)=>{
        queryClient.setQueryData([
            'collection',
            {
                collectionUrl: collectionUrl
 ...
 */ const $600ca419166a1ded$var$useAwaitActivity = (awaitWebSocketConnection: any, existingActivities: any)=>{
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    return (0, $85cNH$useCallback)((matchActivity: any, options = {})=>{
        // @ts-expect-error TS(2339): Property 'timeout' does not exist on type '{}'.
 ...
 */ const $4d1d40fdbcd30589$var$useOutbox = (options = {})=>{
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const post = (0, $85cNH$useCallback)(async (activity: any) => {
...
const $3c17312a40ebf1ed$var$PostCommentForm = ({ context: context, placeholder: placeholder, helperText: helperText, mentions: mentions, userResource: userResource, addItem: addItem, removeItem: removeItem })=>{
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const onSubmit = (0, $85cNH$useCallback)(async (values: any) => {
    ...
    return (
        ...
        /*#__PURE__*/ (0, $85cNH$jsxs)((0, $85cNH$Box), {
            ...
            children: [
                ...
                comments && comments.sort((a: any, b: any)=>new Date(b.published) - new Date(a.published)).map((comment: any) => /*#__PURE__*/ (0, $85cNH$jsxs)((0, $85cNH$Box), {
                        className: classes.container,
                        children: [
                            // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
...
const $75609b4dfb738328$var$getFetchCollectionPage = (fetchFn: any) => async ({ pageParam: pageUri })=>{
...
/** A somewhat hacky way to remove an item from the useInfiniteCollectionQuery. */ const $75609b4dfb738328$var$removeItemFromQueryData = (itemUri: any, collectionQuery: any)=>{
...
var $cebd295d444aa91c$export$2e2bcd8739ae039 = /*#__PURE__*/ (0, $85cNH$forwardRef)((props, ref)=>{
    ...
    return (
        ...
        /*#__PURE__*/ (0, $85cNH$jsx)("div", {
            ...
            // @ts-expect-error TS(2339): Property 'items' does not exist on type '{}'.
            children: props.items.length ? props.items.map((item: any, index: any)=>/*#__PURE__*/ (0, $85cNH$jsx)("button", {
