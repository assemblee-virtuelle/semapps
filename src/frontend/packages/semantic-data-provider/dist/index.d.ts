...
export const createSolidNotificationChannel: (authenticatedFetch: FetchJsonFn, resourceUri: string, options?: CreateSolidChannelOptions) => Promise<any>;
export const createWsChannel: (authenticatedFetch: FetchJsonFn, resourceUri: string, options: CreateSolidChannelOptions) => Promise<WebSocket>;
/**
 ...
 */
export const getOrCreateWsChannel: (authenticatedFetch: FetchJsonFn, resourceUri: string, options?: CreateSolidChannelOptions) => Promise<WebSocket>;
