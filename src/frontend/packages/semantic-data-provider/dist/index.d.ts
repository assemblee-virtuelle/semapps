...
export const buildBlankNodesQuery: (blankNodes: any, baseQuery: any, ontologies: any) => {
    construct: Quad[] | null;
    where: {
        type: string;
        patterns: any[];
...
export const dataProvider: (originalConfig: any) => {
    ...
    ldoDataset: LdoDataset;
    uploadFile: (...arg: any[]) => Promise<any>;
    expandTypes: (...arg: any[]) => Promise<any>;
    getConfig: (...arg: any[]) => Promise<any>;
...
export const useCompactPredicate: (predicate: string, context?: string | string[] | Record<string, string>) => string | undefined;
...
export const GroupedReferenceHandler: ({ children, groupReference, groupLabel, groupHeader, filterProperty, ...otherProps }: any) => JSX.Element;
...
export const createSolidNotificationChannel: (authenticatedFetch: FetchFn, resourceUri: string, options?: CreateSolidChannelOptions) => Promise<any>;
export const createWsChannel: (authenticatedFetch: FetchFn, resourceUri: string, options: CreateSolidChannelOptions) => Promise<WebSocket>;
/**
 ...
 */
export const getOrCreateWsChannel: (authenticatedFetch: FetchFn, resourceUri: string, options?: CreateSolidChannelOptions) => Promise<WebSocket>;
