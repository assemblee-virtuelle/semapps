...
const $c83d324c3b433284$var$fetchSelectedResources = async (containers, excludedResourcesUris, config) => {
  ...
  const selectedResources = await Promise.all(
    selectedResourcesUris.map(resourceUri => (0, $eadae1e342076a7b$export$2e2bcd8739ae039)(resourceUri, config))
  );
...
const $aba124ea15ea8bc6$var$fetchContainers = async (containers, params, config) => {
  ...
  const selectedResources = await (0, $c83d324c3b433284$export$2e2bcd8739ae039)(
    containers,
...
const $4e30f9af2d448bb4$var$defaultToArray = value => (!value ? [] : Array.isArray(value) ? value : [value]);
// We need to always include the type or React-Admin will not work properly
const $4e30f9af2d448bb4$var$typeQuery = (0, $fj9kP$triple)(
  (0, $fj9kP$variable)('s1'),
...
const $4e30f9af2d448bb4$var$buildBaseQuery = (predicates, ontologies) => {
  let baseTriples;
  if (predicates) {
    baseTriples = $4e30f9af2d448bb4$var$defaultToArray(predicates).map((predicate, i) =>
      (0, $fj9kP$triple)(
        (0, $fj9kP$variable)('s1'),
    ...
    return {
      construct: [$4e30f9af2d448bb4$var$typeQuery, ...baseTriples],
      where: [
...
const $8ad7b5ebbca2bb3e$var$buildUnionQuery = queries =>
  queries.map(q => {
    let triples = q.query;
...
const $8ad7b5ebbca2bb3e$var$buildBlankNodesQuery = (blankNodes, baseQuery, ontologies) => {
  ...
  if (nodes && ontologies && ontologies.length > 0) {
    ...
    return {
      ...
      where: {
        type: 'union',
        patterns: [baseQuery.where, ...$8ad7b5ebbca2bb3e$var$buildUnionQuery(queries)]
      }
    };
  }
  return {
...
const {
  literal: $dcde11998342d30d$var$literal,
  namedNode: $dcde11998342d30d$var$namedNode,
  triple: $dcde11998342d30d$var$triple,
  variable: $dcde11998342d30d$var$variable
...
const $dcde11998342d30d$var$buildSparqlQuery = ({
  ...
  const containerWhere = [
    ...
    $dcde11998342d30d$var$triple(
      $dcde11998342d30d$var$variable('containerUri'),
      $dcde11998342d30d$var$namedNode('http://www.w3.org/ns/ldp#contains'),
    ...
    ),
    {
      ...
      expression: {
        type: 'operation',
        operator: 'isiri',
        args: [$dcde11998342d30d$var$variable('s1')]
      }
    }
  ];
  let resourceWhere = [];
  if (filter && Object.keys(filter).length > 0) {
    ...
    */ if (filter.sparqlWhere) {
    ...
    if (filter.q && filter.q.length > 0)
      resourceWhere.push({
        ...
        patterns: [
          {
            queryType: 'SELECT',
            variables: [$dcde11998342d30d$var$variable('s1')],
            where: [
              $dcde11998342d30d$var$triple(
                $dcde11998342d30d$var$variable('s1'),
                $dcde11998342d30d$var$variable('p1'),
              ...
              ),
              {
                ...
                expression: {
                  type: 'operation',
                  operator: 'isliteral',
                  args: [$dcde11998342d30d$var$variable('o1')]
                }
              },
              {
                type: 'filter',
                expression: {
                  ...
                  args: [
                    ...
                    $dcde11998342d30d$var$literal(
                      filter.q.toLowerCase(),
                      '',
                      $dcde11998342d30d$var$namedNode('http://www.w3.org/2001/XMLSchema#string')
                    )
                  ]
                }
              }
    ...
    Object.entries(filter).forEach(([predicate, object]) => {
      if (!$dcde11998342d30d$var$reservedFilterKeys.includes(predicate))
        resourceWhere.unshift(
          $dcde11998342d30d$var$triple(
            $dcde11998342d30d$var$variable('s1'),
            $dcde11998342d30d$var$namedNode((0, $4872a1c30c1fc60e$export$2e2bcd8739ae039)(predicate, ontologies)), // @ts-expect-error TS(2345): Argument of type 'unknown' is not assignable to pa... Remove this comment to see the full error message
  ...
  const blankNodesQuery = blankNodes
    ? (0, $8ad7b5ebbca2bb3e$export$2e2bcd8739ae039)(blankNodes, baseQuery, ontologies)
    : (0, $6aa919fd3fcf3e9c$export$2e2bcd8739ae039)(blankNodesDepth, baseQuery);
  ...
  if (params.sort)
    returnData = returnData.sort((a, b) => {
      if (a[params.sort.field] !== undefined && b[params.sort.field] !== undefined) {
        if (params.sort.order === 'ASC')
          return $4aa3fb2e83f6c3a3$var$compare(a[params.sort.field], b[params.sort.field]);
...
const $4704ee0f6c5ac80d$var$getManyMethod = config => async (resourceId, params) => {
  ...
  let returnData = await Promise.all(
    params.ids.map(id =>
      (0, $4861cda99f97e87d$export$2e2bcd8739ae039)(config)(resourceId, {
 ...
 * @returns
 */ const $00b6445d7042c29d$var$fetchBase =
  (dataServers, fetchFn) =>
  (url, options = {}) => {
...
const $9808be090468fc68$var$dataProvider = originalConfig => {
  ...
  const prepareConfig = async () => {
    ...
    const dataset = (0, $fj9kP$createConnectedLdoDataset)([(0, $fj9kP$solidConnectedPlugin)]);
              ...
              const results = await Promise.all(
                (0, $cc8adac4b83414eb$export$2e2bcd8739ae039)(appRegistration['interop:hasAccessGrant']).map(
                  async accessGrantUri => {
                    ...
                    const container = await (0, $d7a7484a035f15cd$export$2e2bcd8739ae039)(
                    ...
                    if (accessGrant['interop:scopeOfGrant'] === 'interop:AllFromRegistry') return container;
                      ...
                      container.selectedResources = (0, $cc8adac4b83414eb$export$2e2bcd8739ae039)(
...
const $0c5cccc31d3b196d$var$compute = (externalLinks, record) =>
 ...
 *   </FilterHandler>
 * </Show>
 */ const $d8039fd362ad4925$var$FilterHandler = ({
  children: children,
  record: record,
  filter: filter,
  source: source,
 ...
 *
 *
 */ const $207a50667fa8cffa$var$GroupedReferenceHandler = ({
  children: children,
...
export {
  $9808be090468fc68$export$2e2bcd8739ae039 as dataProvider,
  $dcde11998342d30d$export$2e2bcd8739ae039 as buildSparqlQuery,
  $8ad7b5ebbca2bb3e$export$2e2bcd8739ae039 as buildBlankNodesQuery,
  ...
  $0c5cccc31d3b196d$export$2e2bcd8739ae039 as useGetExternalLink,
  $487567a146508c4e$export$2e2bcd8739ae039 as useGetPrefixFromUri,
  $d8039fd362ad4925$export$2e2bcd8739ae039 as FilterHandler,
  $207a50667fa8cffa$export$2e2bcd8739ae039 as GroupedReferenceHandler,
  $1a24ef5e038900c4$export$2e2bcd8739ae039 as ReificationArrayInput,
