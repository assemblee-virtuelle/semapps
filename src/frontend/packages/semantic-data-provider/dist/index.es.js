...
const $7add415f7ebb1122$var$getListMethod =
  ...
  async (resourceId, params = {}) => {
    ...
    if (dataModel.list?.fetchContainer)
      return (0, $3aeefa4731ce9a96$export$2e2bcd8739ae039)(containers, resourceId, params, config);
...
const $c5031381f4dfc62d$var$updateMethod = config => async (resourceId, params) => {
  ...
  $b17c43e3301545ca$export$2e2bcd8739ae039).upload(params.data, config);
  params.data = updatedRecord;
  await httpClient(`${params.id}`, {
    method: 'PUT',
    body: JSON.stringify({
...
const $243bf28fbb1b868f$var$dataProvider = config => {
  ...
  return {
    ...
    update: waitForVoidEndpoints((0, $c5031381f4dfc62d$export$2e2bcd8739ae039)(config)),
    updateMany: () => {
      throw new Error('updateMany is not implemented yet');
    },
    delete: waitForVoidEndpoints((0, $9510970b8e7eb9e2$export$2e2bcd8739ae039)(config)),
  ...
  (0, $fj9kP$useEffect)(() => {
    if (dataModel && dataServers) {
      if (dataModel.create?.container) {
        ...
        setCreateContainer(
          (0, $a6f9067f89a63589$export$2e2bcd8739ae039)(dataModel.types, dataModel.create?.server, dataServers)
        );
      else {
        const defaultServerKey = (0, $8326b88c1a913ca9$export$2e2bcd8739ae039)('default', dataServers);
        setCreateContainer(
          (0, $a6f9067f89a63589$export$2e2bcd8739ae039)(dataModel.types, defaultServerKey, dataServers)
        );
      }
    }
...
export {
  ...
  $349fed82907088e5$export$2e2bcd8739ae039 as useDataModels,
  $11b469d0a927fb46$export$2e2bcd8739ae039 as useDataServers,
