...
const $b17c43e3301545ca$var$getUploadsContainerUri = (config, serverKey) => {
  ...
  if (serverKey)
    return (0, $fj9kP$urljoin)(config.dataServers[serverKey].baseUrl, config.dataServers[serverKey].uploadsContainer); // No server has an uploads container
  else return null;
};
...
const $64441f6e76bd15b6$var$parseServerKeys = (serverKeys, dataServers) => {
  ...
  if (typeof serverKeys === 'string') {
    ...
    return [$64441f6e76bd15b6$var$parseServerKey(serverKeys, dataServers)];
  }
...
const $47d734d7812e6861$var$buildBaseQuery = (predicates, ontologies) => {
  ...
  if (predicates) {
    baseTriples = $47d734d7812e6861$var$defaultToArray(predicates).map((predicate, i) =>
      (0, $fj9kP$triple)(
        (0, $fj9kP$variable)('s1'),
        (0, $fj9kP$namedNode)((0, $564e5d81f6496048$export$2e2bcd8739ae039)(predicate, ontologies)),
    ...
    Object.entries(filter).forEach(([predicate, object]) => {
      if (!$6cde9a8fbbde3ffb$var$reservedFilterKeys.includes(predicate))
        resourceWhere.unshift(
          $6cde9a8fbbde3ffb$var$triple(
            $6cde9a8fbbde3ffb$var$variable('s1'),
            $6cde9a8fbbde3ffb$var$namedNode((0, $564e5d81f6496048$export$2e2bcd8739ae039)(predicate, ontologies)),
            $6cde9a8fbbde3ffb$var$namedNode((0, $564e5d81f6496048$export$2e2bcd8739ae039)(object, ontologies))
          )
        );
    });
  }
...
const $7add415f7ebb1122$var$getListMethod =
  config =>
  async (resourceId, params = {}) => {
    ...
    if (dataModel.list?.fetchContainer)
      return (0, $aba124ea15ea8bc6$export$2e2bcd8739ae039)(containers, params, config);
  ...
  if (token) {
    ...
    if (podKey) {
      ...
      config.dataServers[podKey].sparqlEndpoint =
        userData.endpoints?.['void:sparqlEndpoint'] || (0, $fj9kP$urljoin)(webId, 'sparql');
    }
    if (authServerKey)
      // Fill the config provided to the data provider
      // We must modify the config object directly
...
const $31a4627920feab4a$var$defaultToArray = value => (!value ? undefined : Array.isArray(value) ? value : [value]);
      ...
      for (const dataset of result.datasets) {
        ...
        if (datasetServerKey) {
          ...
          config.dataServers[result.key].containers[datasetServerKey] =
            config.dataServers[result.key].containers[datasetServerKey] || {};
          for (const partition of $31a4627920feab4a$var$defaultToArray(dataset['void:classPartition']))
            for (const type of $31a4627920feab4a$var$defaultToArray(partition['void:class'])) {
...
/** @type {(config: Configuration) => SemanticDataProvider} */ const $243bf28fbb1b868f$var$dataProvider = config => {
  ...
  if (!(0, $8326b88c1a913ca9$export$2e2bcd8739ae039)('default', config.dataServers))
  ...
  return {
    ...
    uploadFile: waitForConfig(rawFile => (0, $b17c43e3301545ca$export$a5575dbeeffdad98)(rawFile, config)),
    refreshConfig: async () => {
      config = {
        ...originalConfig
      };
  ...
  (0, $fj9kP$useEffect)(() => {
    if (dataModel && dataServers) {
      if (dataModel.create?.container) {
        ...
        setCreateContainer(
          (0, $7d9911a250866af6$export$2e2bcd8739ae039)(dataModel.types, dataModel.create?.server, dataServers)
        );
      else {
        const defaultServerKey = (0, $8326b88c1a913ca9$export$2e2bcd8739ae039)('default', dataServers);
        setCreateContainer(
          (0, $7d9911a250866af6$export$2e2bcd8739ae039)(dataModel.types, defaultServerKey, dataServers)
        );
      }
    }
...
const $35f3e75c86e51f35$var$useCreateContainerUri = () => {
  ...
  const dataServers = (0, $4daf4cf698ee4eed$export$2e2bcd8739ae039)();
  const getContainerUri = (0, $fj9kP$useCallback)(
    resourceId => {
...
export {
  ...
  $7bd037d7ec9d51f8$export$2e2bcd8739ae039 as useCreateContainer,
