...
import {v4 as $fj9kP$v4} from "uuid";
...
const $70ad39a4fce59f08$export$c14a9fcbe4547ffc = (fileName)=>{
    const splitFileName = fileName.split(".");
    if (splitFileName.length > 1) {
        const extension = splitFileName.pop();
        return `${(0, $fj9kP$v4)()}.${extension?.toLowerCase()}`;
    }
    return (0, $fj9kP$v4)();
};
const $70ad39a4fce59f08$export$be78b3111c50efdd = (o)=>o?.rawFile && o.rawFile instanceof File;
...
const $70ad39a4fce59f08$var$uploadFile = async (rawFile, config)=>{
    ...
    const response = await config.httpClient(uploadsContainerUri, {
        ...
        body: rawFile,
        headers: new Headers({
            Slug: $70ad39a4fce59f08$export$c14a9fcbe4547ffc(rawFile.name),
 ...
 */ const $70ad39a4fce59f08$var$uploadAllFiles = async (record, config)=>{
    for (const property of Object.keys(record)){
        ...
        if (Array.isArray(value)) {
            for(let i = 0; i < value.length; i++)if ($70ad39a4fce59f08$export$be78b3111c50efdd(value[i])) record[property][i] = await $70ad39a4fce59f08$var$uploadFile(record[property][i].rawFile, config);
        } else if ($70ad39a4fce59f08$export$be78b3111c50efdd(record[property])) record[property] = await $70ad39a4fce59f08$var$uploadFile(record[property].rawFile, config);
    }
    return record;
};
