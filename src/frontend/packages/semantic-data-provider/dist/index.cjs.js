    ...
    Object.entries(filter).forEach(([predicate, object]) => {
      if (!$33c37185da3771a9$var$reservedFilterKeys.includes(predicate))
        resourceWhere.unshift(
          $33c37185da3771a9$var$triple(
            $33c37185da3771a9$var$variable('s1'),
            $33c37185da3771a9$var$namedNode((0, $108795c3831be99f$export$2e2bcd8739ae039)(predicate, ontologies)),
            $33c37185da3771a9$var$namedNode((0, $108795c3831be99f$export$2e2bcd8739ae039)(object, ontologies))
          )
        );
    });
  }
...
const $9ab033d1ec46b5da$var$isURL = value =>
...
const $9ab033d1ec46b5da$var$expandTypes = async (types, context) => {
  ...
  if (!expandedTypes.every(type => $9ab033d1ec46b5da$var$isURL(type)))
    throw new Error(`
...
/** @type {(originalConfig: Configuration) => SemanticDataProvider} */ const $7f6a16d0025dc83a$var$dataProvider =
  originalConfig => {
            ...
            const results = await Promise.all(
              (0, $e6fbab1f303bdb93$export$2e2bcd8739ae039)(appRegistration['interop:hasAccessGrant']).map(
                async accessGrantUri => {
                  ...
                  return Promise.all(
                    (0, $e6fbab1f303bdb93$export$2e2bcd8739ae039)(accessGrant['interop:hasDataGrant']).map(
                      async dataGrantUri => {
                        const { json: dataGrant } = await config.httpClient(dataGrantUri);
                        return (0, $37dc42f6e1c3b4af$export$2e2bcd8739ae039)(
