...
const $b25e308d395234ef$var$isFile = o => o?.rawFile && o.rawFile instanceof File;
const $b25e308d395234ef$var$getUploadsContainerUri = config => {
...
const $b25e308d395234ef$var$uploadFile = async (rawFile, config) => {
  const uploadsContainerUri = $b25e308d395234ef$var$getUploadsContainerUri(config);
 ...
 */ const $b25e308d395234ef$var$uploadAllFiles = async (record, config) => {
  for (const property of Object.keys(record)) {
    const value = record[property];
    if (Array.isArray(value)) {
      for (let i = 0; i < value.length; i++)
        if ($b25e308d395234ef$var$isFile(value[i]))
          record[property][i] = await $b25e308d395234ef$var$uploadFile(record[property][i].rawFile, config);
    } else if ($b25e308d395234ef$var$isFile(record[property]))
      record[property] = await $b25e308d395234ef$var$uploadFile(record[property].rawFile, config);
  }
  return record;
};
var $b25e308d395234ef$export$2e2bcd8739ae039 = $b25e308d395234ef$var$uploadAllFiles;
...
const $982f4f2fb185d606$var$parseServerKeys = (serverKeys, dataServers) => {
  ...
  if (typeof serverKeys === 'string') {
    ...
    return [$982f4f2fb185d606$var$parseServerKey(serverKeys, dataServers)];
  }
...
const $907cbc087f6529e2$var$createMethod = config => async (resourceId, params) => {
  ...
  if (dataModel.create?.container) {
    ...
    containerUri = (0, $parcel$interopDefault($bkNnK$urljoin))(
      dataServers[serverKey].baseUrl,
      Object.values(dataModel.create.container)[0]
    );
  } else {
  ...
  if (params.data) {
    ...
    params.data = await (0, $b25e308d395234ef$export$2e2bcd8739ae039)(params.data, config);
    ...
    httpClient(containerUri)
      .then(({ json: json }) => {
        ...
        if (json['@context'] !== jsonContext)
          return (0, $parcel$interopDefault($bkNnK$jsonld)).compact(json, jsonContext);
        return json;
      })
      .then(json => {
...
const $51d7c29cc84f802b$var$defaultToArray = value => (!value ? [] : Array.isArray(value) ? value : [value]);
// We need to always include the type or React-Admin will not work properly
const $51d7c29cc84f802b$var$typeQuery = (0, $bkNnK$rdfjsdatamodel.triple)(
...
const $51d7c29cc84f802b$var$buildBaseQuery = (predicates, ontologies) => {
  let baseTriples;
  if (predicates) {
    baseTriples = $51d7c29cc84f802b$var$defaultToArray(predicates).map((predicate, i) =>
      (0, $bkNnK$rdfjsdatamodel.triple)(
        (0, $bkNnK$rdfjsdatamodel.variable)('s1'),
        (0, $bkNnK$rdfjsdatamodel.namedNode)((0, $761c677606459117$export$2e2bcd8739ae039)(predicate, ontologies)),
        (0, $bkNnK$rdfjsdatamodel.variable)(`o${i + 1}`)
      )
    );
    return {
      construct: [$51d7c29cc84f802b$var$typeQuery, ...baseTriples],
      where: [
...
const $64d4ce40c79d1509$var$buildUnionQuery = queries =>
  queries.map(q => {
    let triples = q.query;
...
const $64d4ce40c79d1509$var$buildBlankNodesQuery = (blankNodes, baseQuery, ontologies) => {
  ...
  if (nodes && ontologies && ontologies.length > 0) {
    ...
    return {
      ...
      where: {
        type: 'union',
        patterns: [baseQuery.where, ...$64d4ce40c79d1509$var$buildUnionQuery(queries)]
      }
    };
  }
  return {
...
const {
  literal: $33c37185da3771a9$var$literal,
  namedNode: $33c37185da3771a9$var$namedNode,
  triple: $33c37185da3771a9$var$triple,
  variable: $33c37185da3771a9$var$variable
...
const $33c37185da3771a9$var$buildSparqlQuery = ({
  ...
  const containerWhere = [
    ...
    $33c37185da3771a9$var$triple(
      $33c37185da3771a9$var$variable('containerUri'),
      $33c37185da3771a9$var$namedNode('http://www.w3.org/ns/ldp#contains'),
    ...
    ),
    {
      ...
      expression: {
        type: 'operation',
        operator: 'isiri',
        args: [$33c37185da3771a9$var$variable('s1')]
      }
    }
  ];
  let resourceWhere = [];
  if (filter && Object.keys(filter).length > 0) {
    ...
    if (hasFullTextSearch)
      resourceWhere.push({
        ...
        patterns: [
          {
            queryType: 'SELECT',
            variables: [$33c37185da3771a9$var$variable('s1')],
            where: [
              $33c37185da3771a9$var$triple(
                $33c37185da3771a9$var$variable('s1'),
                $33c37185da3771a9$var$variable('p1'),
              ...
              ),
              {
                ...
                expression: {
                  type: 'operation',
                  operator: 'isliteral',
                  args: [$33c37185da3771a9$var$variable('o1')]
                }
              },
              {
                type: 'filter',
                expression: {
                  ...
                  args: [
                    ...
                    $33c37185da3771a9$var$literal(
                      filter.q.toLowerCase(),
                      '',
                      $33c37185da3771a9$var$namedNode('http://www.w3.org/2001/XMLSchema#string')
                    )
                  ]
                }
              }
    ...
    Object.entries(filter).forEach(([predicate, object]) => {
      if (!$33c37185da3771a9$var$reservedFilterKeys.includes(predicate))
        resourceWhere.unshift(
          $33c37185da3771a9$var$triple(
            $33c37185da3771a9$var$variable('s1'),
            $33c37185da3771a9$var$namedNode((0, $761c677606459117$export$2e2bcd8739ae039)(predicate, ontologies)),
            $33c37185da3771a9$var$namedNode((0, $761c677606459117$export$2e2bcd8739ae039)(object, ontologies))
          )
        );
    });
  }
  ...
  const blankNodesQuery = blankNodes
    ? (0, $64d4ce40c79d1509$export$2e2bcd8739ae039)(blankNodes, baseQuery, ontologies)
    : (0, $3b137d792e8838ac$export$2e2bcd8739ae039)(blankNodesDepth, baseQuery);
    ...
    returnData = returnData.sort((a, b) => {
      if (a[params.sort.field] !== undefined && b[params.sort.field] !== undefined) {
        if (params.sort.order === 'ASC')
          return $1e7a94d745f8597b$var$compare(a[params.sort.field], b[params.sort.field]);
...
const $b6ed253f3374f5d4$var$getListMethod =
  config =>
  async (resourceId, params = {}) => {
    ...
    if (dataModel.list?.fetchContainer)
      return (0, $6e66f3a2f960b9ca$export$2e2bcd8739ae039)(containers, resourceId, params, config);
...
const $e296494b4f6a4f89$var$getManyMethod = config => async (resourceId, params) => {
  ...
  let returnData = await Promise.all(
    params.ids.map(id =>
      (0, $9020b8e3f4a4c1a1$export$2e2bcd8739ae039)(config)(resourceId, {
  ...
  if (token) {
    ...
    if (podKey) {
      ...
      config.dataServers[podKey].sparqlEndpoint =
        userData.endpoints?.['void:sparqlEndpoint'] || (0, $parcel$interopDefault($bkNnK$urljoin))(webId, 'sparql');
    }
    if (authServerKey)
      // Fill the config provided to the data provider
      // We must modify the config object directly
...
const $915df908e0942746$var$defaultToArray = value => (!value ? undefined : Array.isArray(value) ? value : [value]);
      ...
      for (const dataset of result.datasets) {
        ...
        if (datasetServerKey) {
          ...
          config.dataServers[result.key].containers[datasetServerKey] =
            config.dataServers[result.key].containers[datasetServerKey] || {};
          for (const partition of $915df908e0942746$var$defaultToArray(dataset['void:classPartition']))
            for (const type of $915df908e0942746$var$defaultToArray(partition['void:class'])) {
              ...
              else config.dataServers[result.key].containers[datasetServerKey][type] = [path];
            }
        }
      }
  }
 ...
 */ const $341dff85fe619d85$var$httpClient =
  dataServers =>
  (url, options = {}) => {
    const authServerKey = (0, $8f44b7c15b8b8e1d$export$2e2bcd8739ae039)('authServer', dataServers);
...
const $7f6a16d0025dc83a$var$dataProvider = config => {
  ...
  if (!(0, $8f44b7c15b8b8e1d$export$2e2bcd8739ae039)('default', config.dataServers))
...
const $85e9a897c6d7c14a$var$compute = (externalLinks, record) =>
...
const $3158e0dc13ffffaa$var$useContainers = (resourceId, serverKeys = '@all') => {
  ...
  (0, $bkNnK$react.useEffect)(() => {
    if (dataModel && dataServers)
      setContainers((0, $047a107b0d203793$export$2e2bcd8739ae039)(dataModel.types, serverKeys, dataServers));
  ...
  (0, $bkNnK$react.useEffect)(() => {
    if (dataModel && dataServers) {
      if (dataModel.create?.container) {
        ...
        setCreateContainer(
          (0, $b32fd11d6aa83d1c$export$2e2bcd8739ae039)(dataModel.types, dataModel.create?.server, dataServers)
        );
      else {
        const defaultServerKey = (0, $8f44b7c15b8b8e1d$export$2e2bcd8739ae039)('default', dataServers);
        setCreateContainer(
          (0, $b32fd11d6aa83d1c$export$2e2bcd8739ae039)(dataModel.types, defaultServerKey, dataServers)
        );
      }
    }
 ...
 *   </FilterHandler>
 * </Show>
 */ const $f763906f9b20f2d8$var$FilterHandler = ({
  children: children,
  record: record,
  filter: filter,
  source: source,
 ...
 *
 *
 */ const $b4703fef6d6af456$var$GroupedReferenceHandler = ({
  children: children,
