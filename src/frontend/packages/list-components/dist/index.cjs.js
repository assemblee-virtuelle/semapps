  ...
  return /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsxs)(Component, {
    ...
    children: [
      data.map(record => {
        ...
        if (externalLink)
          return /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)(
            (0, $5MILa$reactadmin.RecordContextProvider),
            {
              value: record,
              children: /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)('a', {
                ...
                children: /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$reactadmin.ChipField), {
                  ...
                  color: 'secondary',
                  deleteIcon: /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)(
                    (0, $parcel$interopDefault($5MILa$muiiconsmaterialLaunch)),
                    {
      ...
      appendLink &&
        /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $parcel$interopDefault($5MILa$muiiconsmaterialAddCircle)), {
          color: 'primary',
...
const $a4d27c2ab268c05b$var$GridList = ({
  children: children,
  linkType: linkType,
  ...
  return /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$muimaterial.Grid), {
    ...
    children: data.map(record => {
      ...
      let child;
      if (externalLink)
        child = /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)('a', {
          href: externalLink,
          target: '_blank',
          rel: 'noopener noreferrer',
        ...
        child = /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$reactadmin.Link), {
          to: createPath({
            resource: resource,
            id: record.id,
            type: linkType
 ...
 *   />
 * </List>
 */ const $bc22719d52a02d2c$var$MasonryList = ({
  image: image,
  content: content,
  actions: actions,
  ...
  return /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $parcel$interopDefault($5MILa$reactmasonrycss)), {
    ...
    children: data.map(record => {
      ...
      return /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$reactadmin.RecordContextProvider), {
        value: record,
        children: /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsxs)(
          (0, $5MILa$muimaterial.Card),
          {
            ...
            children: [
              /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$reactadmin.Link), {
                ...
                children: /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsxs)((0, $5MILa$muimaterial.CardActionArea), {
                  children: [
                    imageUrl &&
                      /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$muimaterial.CardMedia), {
                        className: classes.media,
                        image: imageUrl
                      }),
                    content &&
                      /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$muimaterial.CardContent), {
              ...
              actions &&
                /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$muimaterial.CardActions), {
                  children: actions.map(action =>
                    /*#__PURE__*/ (0, $parcel$interopDefault($5MILa$react)).createElement(action)
                  )
                })
            ]
          },
...
const $696f298352ead676$var$ReferenceFilterCounter = ({ source: source, id: id }) => {
  ...
  return /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsxs)((0, $5MILa$reactjsxruntime.Fragment), {
    children: [
      '\xa0',
      data &&
        /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)('span', {
...
const $696f298352ead676$var$ReferenceFilter = ({
  reference: reference,
  source: source,
  ...
  return /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$reactadmin.FilterList), {
    ...
    icon:
      icon || currentResource?.icon ? /*#__PURE__*/ (0, $5MILa$react.createElement)(currentResource.icon) : undefined,
    children:
      data &&
      data
        .filter(itemData => itemIsUsed(itemData))
        .map(itemData =>
          /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)(
            (0, $5MILa$reactadmin.FilterListItem),
            {
              label: /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsxs)('span', {
                ...
                children: [
                  itemData['pair:label'],
                  showCounters &&
                    /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)($696f298352ead676$var$ReferenceFilterCounter, {
                      source: source,
                      id: itemData.id
                    })
                ]
...
const $2b75f3c2996d19f7$var$ViewsButtons = () => {
  ...
  const {
    ...
    setView: setView
  } = (0, $parcel$interopDefault($5MILa$react)).useContext((0, $1f2a4ca7a7e2b912$export$2e2bcd8739ae039));
  return views
...
const $6ca83fab5dd482a0$var$ListActionsWithViews = ({
  ...
  return /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsxs)((0, $5MILa$reactadmin.TopToolbar), {
    children: [
      ...
      filters &&
        /*#__PURE__*/ (0, $parcel$interopDefault($5MILa$react)).cloneElement(filters, {
          showFilter: showFilter,
          displayedFilters: displayedFilters,
          filterValues: filterValues,
          context: 'button'
      ...
      resourceDefinition.hasCreate &&
        /*#__PURE__*/ (0, $5MILa$reactjsxruntime.jsx)((0, $5MILa$reactadmin.CreateButton), {}),
      !xs &&
        exporter !== false &&
      ...
      bulkActions &&
        /*#__PURE__*/ (0, $parcel$interopDefault($5MILa$react)).cloneElement(bulkActions, {
          filterValues: filterValues,
          selectedIds: selectedIds,
          onUnselectItems: onUnselectItems
        })
...
const $8e315201c1049d3f$var$MultiViewsList = ({
  children: children,
  actions: actions,
  views: views,
