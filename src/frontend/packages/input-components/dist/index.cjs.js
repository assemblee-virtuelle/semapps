...
const $8da7e3307934259f$var$ImageInput = props =>
  /*#__PURE__*/ (0, $3asgq$reactjsxruntime.jsx)((0, $3asgq$reactadmin.ImageInput), {
    ...props,
...
const $a3ccd82fa8860009$var$OptionRenderer = ({ optionText: optionText, dataServers: dataServers }) => {
  ...
  return /*#__PURE__*/ (0, $3asgq$reactjsxruntime.jsxs)('span', {
    children: [
      record[optionText],
      server &&
        /*#__PURE__*/ (0, $3asgq$reactjsxruntime.jsxs)('em', {
...
const $bb612fb8f67b03e0$var$MultiServerAutocompleteArrayInput = ({ optionText: optionText, ...rest }) => {
  ...
  const matchSuggestion = (0, $3asgq$react.useCallback)(
...
const $6c505c4dc3e51ff8$var$MultiServerAutocompleteInput = ({ optionText: optionText, ...rest }) => {
  ...
  const optionTextWithServerName = (0, $3asgq$react.useCallback)(
    record => {
...
const $9aa37fe333ef760c$var$MultiLinesInput = props =>
  /*#__PURE__*/ (0, $3asgq$reactjsxruntime.jsx)((0, $3asgq$reactadmin.TextInput), {
    multiline: true,
    minRows: 2,
...
const $83ac3fff69969204$var$ReferenceArrayInput = props => {
  ...
  } = (0, $3asgq$reacthookform.useController)({
    name: props.source
  });
