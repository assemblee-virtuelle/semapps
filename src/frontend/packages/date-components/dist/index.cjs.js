...
const $c332daa71b957685$var$Picker = ({
  ...
  const handleChange = (0, $3RhHq$react.useCallback)(
    value => {
  ...
  const translatedLabel = /*#__PURE__*/ (0, $3RhHq$reactjsxruntime.jsxs)('span', {
    children: [
      ...
      isRequired &&
        /*#__PURE__*/ (0, $3RhHq$reactjsxruntime.jsx)('span', {
          'aria-hidden': 'true',
          children: '\u2009*'
        })
    ]
  });
  return /*#__PURE__*/ (0, $3RhHq$reactjsxruntime.jsx)(
    (0, $3RhHq$muixdatepickersLocalizationProvider.LocalizationProvider),
    {
...
const $c8dbd8ec3b8f34cc$var$useFullCalendarProps = ({
  label: label,
  startDate: startDate,
  endDate: endDate,
  linkType: linkType
  ...
  const datesSet = (0, $3RhHq$react.useCallback)(
    ({ view: view }) => {
  ...
  const events = (0, $3RhHq$react.useMemo)(
    () =>
      !isLoading &&
      data
...
const $563c84827e91e322$var$CalendarList = props => {
  ...
  return /*#__PURE__*/ (0, $3RhHq$reactjsxruntime.jsx)((0, $parcel$interopDefault($3RhHq$fullcalendarreact)), {
    plugins: [(0, $parcel$interopDefault($3RhHq$fullcalendardaygrid))],
    locale: props.locale,
...
const $5379d12b87e743a4$var$DaysList = props => {
  ...
  return /*#__PURE__*/ (0, $3RhHq$reactjsxruntime.jsx)((0, $parcel$interopDefault($3RhHq$fullcalendarreact)), {
    plugins: [(0, $parcel$interopDefault($3RhHq$fullcalendarlist))],
    locale: props.locale,
...
const $0ec82123656742c1$export$7edc06cf1783b30f = props =>
  /*#__PURE__*/ (0, $3RhHq$reactjsxruntime.jsx)((0, $c332daa71b957685$export$2e2bcd8739ae039), {
    PickerComponent: (0, $3RhHq$muixdatepickersDatePicker.DatePicker),
    ...props
  });
const $0ec82123656742c1$export$a1af6f79df847fac = props =>
  /*#__PURE__*/ (0, $3RhHq$reactjsxruntime.jsx)((0, $c332daa71b957685$export$2e2bcd8739ae039), {
    PickerComponent: (0, $3RhHq$muixdatepickersTimePicker.TimePicker),
    ...props
  });
const $0ec82123656742c1$export$183478aa40b5df1 = props =>
  /*#__PURE__*/ (0, $3RhHq$reactjsxruntime.jsx)((0, $c332daa71b957685$export$2e2bcd8739ae039), {
