...
const $3a4b4c603fe6b68b$var$capitalizeFirstLetter = string =>
  string && string.charAt(0).toUpperCase() + string.slice(1);
const $3a4b4c603fe6b68b$var$LexiconAutocompleteInput = /*#__PURE__*/ (0, $as47w$react.forwardRef)(
  (
    {
    ...
    const throttledFetchLexicon = (0, $as47w$react.useMemo)(
      () =>
        (0, $parcel$interopDefault($as47w$lodashthrottle))((keyword, callback) => {
          fetchLexicon({
            keyword: keyword,
            locale: locale
          })
    ...
    return /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)((0, $parcel$interopDefault($as47w$muimaterialAutocomplete)), {
      ...
      isOptionEqualToValue: (option, value) =>
        $3a4b4c603fe6b68b$var$selectOptionText(option, optionText) ===
        $3a4b4c603fe6b68b$var$selectOptionText(value, optionText),
      ...
      renderInput: params => {
        ...
        return /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)((0, $as47w$muimaterial.TextField), {
          ...
          label:
            label !== '' &&
            label !== false &&
            /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)((0, $as47w$reactadmin.FieldTitle), {
              label: label,
              source: source,
              resource: resource,
              isRequired: isRequired
        ...
        return /*#__PURE__*/ (0, $as47w$react.createElement)((0, $as47w$muimaterial.Grid), {
          ...
          children: [
            /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)((0, $as47w$muimaterial.Grid), {
              item: true,
              children: /*#__PURE__*/ (0, $parcel$interopDefault($as47w$react)).createElement(
                option.icon || (0, $parcel$interopDefault($as47w$muiiconsmaterialLanguage)),
                {
              ...
              children: [
                typeof parts === 'string'
                  ...
                  : parts.map((part, index) =>
                      /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)(
                        'span',
                        {
                          style: {
...
const $af88cd35a927a884$var$LexiconCreateDialog = ({ fetchLexicon: fetchLexicon, selectData: selectData }) => {
  const {
    ...
    onCancel: onCancel,
    onCreate: onCreate
  } = (0, $as47w$reactadmin.useCreateSuggestionContext)();
  const resource = (0, $as47w$reactadmin.useResourceContext)();
...
const $3722be33fafb3622$var$useFork = resourceId => {
  ...
  const notify = (0, $as47w$reactadmin.useNotify)();
  return (0, $as47w$react.useCallback)(
  ...
  return /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsxs)((0, $as47w$reactjsxruntime.Fragment), {
    children: [
      containers &&
        ...
        /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)((0, $as47w$semappsinputcomponents.ReferenceInput), {
          source: 'remoteUri',
          reference: resource,
          filter: {
            _servers: '@remote',
          ...
          children: /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)(
            (0, $as47w$semappsinputcomponents.MultiServerAutocompleteInput),
            {
...
const $fb5291a8e3f7cfea$var$CreateOrImportForm = ({ stripProperties: stripProperties, ...rest }) => {
  ...
  return /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsxs)((0, $as47w$reactjsxruntime.Fragment), {
    children: [
      ...
      tab === 0 &&
        /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)((0, $as47w$reactadmin.SimpleForm), {
          ...rest
        }),
      tab === 1 &&
        /*#__PURE__*/ (0, $as47w$reactjsxruntime.jsx)((0, $eaef283c22eb901e$export$2e2bcd8739ae039), {
...
const $32077f9119e727a8$var$fetchWikidata =
...
const $17a31747492cb646$var$fetchESCO =
  (apiUrl = 'https://ec.europa.eu/esco/api', type = 'skill') =>
  async ({ keyword: keyword, locale: locale }) => {
    const response = await fetch(
      (0, $parcel$interopDefault($as47w$urljoin))(
        apiUrl,
