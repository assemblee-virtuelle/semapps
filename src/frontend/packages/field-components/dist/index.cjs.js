...
const $4e17293ac0574285$var$AvatarWithLabelField = ({
  label: label,
      ...
      !computedLabel
        ...
        : externalLink
          ? /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.Chip), {
              ...
              size: 'small',
              label: computedLabel,
              deleteIcon: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
                (0, $parcel$interopDefault($gJbUX$muiiconsmaterialLaunch)),
                {
...
const $c7e6f337903f861b$var$ResultsList = ({
  keyword: keyword,
  source: source,
  reference: reference,
  ...
  const search = (0, $gJbUX$react.useMemo)(
    () =>
      (0, $parcel$interopDefault($gJbUX$lodashdebounce))(keyword => {
        dataProvider
          .getList(reference, {
            pagination: {
              page: 1,
    ...
    children: [
      loaded &&
        results.map(resource =>
          /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsxs)(
            (0, $gJbUX$muimaterial.ListItem),
            {
              button: true,
              ...
              children: [
                /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.ListItemAvatar), {
                  children: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.Avatar), {
                    children: /*#__PURE__*/ (0, $parcel$interopDefault($gJbUX$react)).createElement(
                      referenceDefinition.icon
                    )
                  })
                }),
                ...
                /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.ListItemSecondaryAction), {
                  children: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)('a', {
                    ...
                    children: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.IconButton), {
                      edge: 'end',
                      size: 'large',
                      children: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
                        (0, $parcel$interopDefault($gJbUX$muiiconsmaterialVisibility)),
                        {}
                      )
                    })
                  })
        ...
        /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsxs)((0, $gJbUX$muimaterial.ListItem), {
          children: [
            /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.ListItemAvatar), {
              children: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.Avatar), {
                children: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
                  (0, $parcel$interopDefault($gJbUX$muiiconsmaterialError)),
                  {}
                )
              })
            }),
        ...
        /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsxs)((0, $gJbUX$muimaterial.ListItem), {
          ...
          children: [
            /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.ListItemAvatar), {
              children: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.Avatar), {
                children: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
                  (0, $parcel$interopDefault($gJbUX$muiiconsmaterialAdd)),
                  {}
                )
              })
            }),
      ...
      loading &&
        /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.Box), {
          display: 'flex',
          alignItems: 'center',
...
const $9ac0ba4780250906$var$QuickAppendDialog = ({
  open: open,
  onClose: onClose,
  ...
  const appendLink = (0, $gJbUX$react.useCallback)(
    async objectUri => {
  ...
  const create = (0, $gJbUX$react.useCallback)(
    async values => {
  ...
  return /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$muimaterial.Dialog), {
    ...
    children:
      panel === 'find'
        ? /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsxs)((0, $gJbUX$reactjsxruntime.Fragment), {
            children: [
              ...
              /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsxs)((0, $gJbUX$muimaterial.DialogActions), {
                ...
                children: [
                  /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$reactadmin.Button), {
                    ...
                    variant: 'contained',
                    startIcon: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
                      (0, $parcel$interopDefault($gJbUX$muiiconsmaterialAdd)),
                      {}
                    ),
                    type: 'submit'
...
const $6a1cce6d258bf615$var$QuickAppendReferenceArrayField = ({
  reference: reference,
  source: source,
  resource: resource,
  children: children,
  ...
  const canAppend = (0, $gJbUX$react.useMemo)(
  ...
  return /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsxs)((0, $gJbUX$reactjsxruntime.Fragment), {
    children: [
      /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $b6ed9e2776cb4ba3$export$2e2bcd8739ae039), {
        ...
        ...otherProps,
        children:
          (0, $parcel$interopDefault($gJbUX$react)).Children.only(children) &&
          /*#__PURE__*/ (0, $parcel$interopDefault($gJbUX$react)).cloneElement(children, {
            appendLink: canAppend ? () => setShowDialog(true) : undefined
          })
      }),
      canAppend &&
        showDialog &&
        /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $9ac0ba4780250906$export$2e2bcd8739ae039), {
          open: showDialog,
...
const $732a429355ed7119$var$defaultdomainMapping = {
  ...
  'facebook.com': {
    label: 'Facebook',
    icon: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
      (0, $parcel$interopDefault($gJbUX$muiiconsmaterialFacebook)),
      {}
    ),
    color: '#4267B2',
    contrastText: 'white'
  ...
  'twitter.com': {
    label: 'Twitter',
    icon: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
      (0, $parcel$interopDefault($gJbUX$muiiconsmaterialTwitter)),
      {}
    ),
    color: '#00ACEE',
    contrastText: 'white'
  ...
  'instagram.com': {
    label: 'Instagram',
    icon: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
      (0, $parcel$interopDefault($gJbUX$muiiconsmaterialInstagram)),
      {}
    ),
    color: '#8a3ab9',
    contrastText: 'white'
  ...
  'youtube.com': {
    label: 'YouTube',
    icon: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
      (0, $parcel$interopDefault($gJbUX$muiiconsmaterialYouTube)),
      {}
    ),
    color: '#FF0000',
    contrastText: 'white'
...
const $732a429355ed7119$var$MultiUrlField = ({ source: source, domainMapping: domainMapping }) => {
  ...
  return urlArray.map((url, index) => {
    ...
    const chip = newDomainMapping[parsedUrl.hostname] || {
      label: 'Site web',
      icon: /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
        (0, $parcel$interopDefault($gJbUX$muiiconsmaterialLanguage)),
        {}
      ),
      color: '#ea',
      contrastText: 'black'
    };
    return /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)(
      'a',
      {
        href: url,
        target: '_blank',
...
const $43c570e3fbe4d9a0$var$SeparatedListField = props => {
  ...
  return /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsx)((0, $gJbUX$reactjsxruntime.Fragment), {
    children: data.map((record, i) => {
      ...
      if (resourceLinkPath)
        return /*#__PURE__*/ (0, $gJbUX$reactjsxruntime.jsxs)(
          'span',
          {
            children: [
