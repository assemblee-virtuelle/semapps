...
import $4dBGn$react, {
  useState as $4dBGn$useState,
  useMemo as $4dBGn$useMemo,
  useEffect as $4dBGn$useEffect
} from 'react';
import {
  useRecordContext as $4dBGn$useRecordContext,
  useResourceContext as $4dBGn$useResourceContext,
  useLocale as $4dBGn$useLocale,
  useTranslate as $4dBGn$useTranslate,
  useInput as $4dBGn$useInput,
  FieldTitle as $4dBGn$FieldTitle,
  InputHelperText as $4dBGn$InputHelperText,
  useListContext as $4dBGn$useListContext,
  RecordContextProvider as $4dBGn$RecordContextProvider,
  useResourceDefinition as $4dBGn$useResourceDefinition,
  ShowButton as $4dBGn$ShowButton,
  EditButton as $4dBGn$EditButton
} from 'react-admin';
import {
  TextField as $4dBGn$TextField,
  Grid as $4dBGn$Grid,
  Typography as $4dBGn$Typography,
  useMediaQuery as $4dBGn$useMediaQuery,
  Box as $4dBGn$Box,
  Drawer as $4dBGn$Drawer,
  IconButton as $4dBGn$IconButton
} from '@mui/material';
...
import {
  Marker as $4dBGn$Marker,
  Popup as $4dBGn$Popup,
  Polyline as $4dBGn$Polyline,
  MapContainer as $4dBGn$MapContainer,
  TileLayer as $4dBGn$TileLayer,
  useMapEvents as $4dBGn$useMapEvents,
  useMap as $4dBGn$useMap
} from 'react-leaflet';
...
const $30efcd78e923a66d$var$StyledLocationOnIcon = (0, $4dBGn$styled)((0, $4dBGn$muiiconsmaterialLocationOn))(
  ({ theme: theme }) => ({
...
const $30efcd78e923a66d$var$LocationInput = ({
  ...
  // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
  const {
    field: { value: value, onChange: onChange, onBlur: onBlur /* , onFocus */ },
    isRequired: isRequired,
    fieldState: { error: error, isTouched: /* submitError, */ isTouched }
  } = (0, $4dBGn$useInput)({
    resource: resource,
    source: source,
    ...rest
  ...
  // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
  const fetchMapbox = (0, $4dBGn$useMemo)(
    () =>
      (0, $4dBGn$lodashthrottle)((keyword: any, callback: any) => {
  ...
  return (
    ...
    /*#__PURE__*/ (0, $4dBGn$jsx)((0, $4dBGn$muimaterialAutocomplete), {
      ...
      isOptionEqualToValue: (option: any, value: any) =>
        $30efcd78e923a66d$var$selectOptionText(option, optionText) ===
        $30efcd78e923a66d$var$selectOptionText(value, optionText),
        ...
        return (
          ...
          /*#__PURE__*/ (0, $4dBGn$jsx)((0, $4dBGn$TextField), {
            ...
            label:
              label !== '' &&
              label !== false &&
              /*#__PURE__*/ (0, $4dBGn$jsx)((0, $4dBGn$FieldTitle), {
                label: label,
                source: source,
                resource: resource,
                isRequired: isRequired
...
// @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
const $30b7ce6cee91ee5d$var$MarkerClusterGroup = (0, $4dBGn$createPathComponent)(
  $30b7ce6cee91ee5d$var$createMarkerCluster
);
...
const $845cccf8fd290d00$var$MobileDrawer = ({ popupContent: popupContent, onClose: onClose }) => {
  ...
  // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
  (0, $4dBGn$useEffect)(() => {
    if (record) map.setView([record.latitude, record.longitude]);
  }, [record, map]);
  // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
...
const $6ec4ba22c7861081$var$MapList = ({
  latitude: latitude,
  longitude: longitude,
  label: label,
  description: description,
  popupContent: popupContent = (0, $0af94055ba27b10f$export$2e2bcd8739ae039),
  height: height = 700,
  center: center = [
    47, 2.213749
  ...
  zoom: zoom = 6,
  groupClusters: groupClusters = true,
  boundToMarkers: boundToMarkers,
  connectMarkers: connectMarkers = false,
  ...
  const markers = records.map((record, i) => {
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const marker = /*#__PURE__*/ (0, $4dBGn$jsxs)(
      (0, $4dBGn$react).Fragment,
      {
        children: [
          // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
          /*#__PURE__*/ (0, $4dBGn$jsx)((0, $4dBGn$Marker), {
            ...
            children:
              !xs &&
              /*#__PURE__*/ (0, $4dBGn$jsx)((0, $4dBGn$Popup), {
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
          ...
          connectMarkers &&
            previousRecord &&
            /*#__PURE__*/ (0, $4dBGn$jsx)((0, $4dBGn$Polyline), {
              positions: [
  ...
  return /*#__PURE__*/ (0, $4dBGn$jsxs)((0, $4dBGn$MapContainer), {
    ...
    children: [
      ...
      // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
      isLoading &&
        /*#__PURE__*/ (0, $4dBGn$jsx)((0, $4dBGn$Box), {
          alignItems: 'center',
      ...
      // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
      groupClusters
        ? /*#__PURE__*/ (0, $4dBGn$jsx)((0, $30b7ce6cee91ee5d$export$2e2bcd8739ae039), {
...
// @ts-expect-error TS(7031): Binding element 'latitude' implicitly has an 'any'... Remove this comment to see the full error message
const $c0e51b97cc9ee3d2$var$MapField = ({
  latitude: latitude,
  longitude: longitude,
  address: address,
  height: height = 400,
...
export {
  $85f5b044a3dfefc9$export$2e2bcd8739ae039 as extractContext,
  $30efcd78e923a66d$export$2e2bcd8739ae039 as LocationInput,
  $6ec4ba22c7861081$export$2e2bcd8739ae039 as MapList,
  $c0e51b97cc9ee3d2$export$2e2bcd8739ae039 as MapField
};
