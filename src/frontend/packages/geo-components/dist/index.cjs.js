...
const $7a57fad6c56283a6$var$StyledLocationOnIcon = (0, $CiwlJ$muisystem.styled)(
  (0, $parcel$interopDefault($CiwlJ$muiiconsmaterialLocationOn))
)(({ theme: theme }) => ({
...
const $7a57fad6c56283a6$var$LocationInput = ({
  ...
  } = (0, $CiwlJ$reactadmin.useInput)({
    resource: resource,
    source: source,
    ...rest
  });
  const fetchMapbox = (0, $CiwlJ$react.useMemo)(
    () =>
      (0, $parcel$interopDefault($CiwlJ$lodashthrottle))((keyword, callback) => {
  ...
  return /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $parcel$interopDefault($CiwlJ$muimaterialAutocomplete)), {
    ...
    isOptionEqualToValue: (option, value) =>
      $7a57fad6c56283a6$var$selectOptionText(option, optionText) ===
      $7a57fad6c56283a6$var$selectOptionText(value, optionText),
    ...
    renderInput: params => {
      ...
      return /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $CiwlJ$muimaterial.TextField), {
        ...
        label:
          label !== '' &&
          label !== false &&
          /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $CiwlJ$reactadmin.FieldTitle), {
            label: label,
            source: source,
            resource: resource,
            isRequired: isRequired
              ...
              children: [
                typeof parts === 'string'
                  ...
                  : parts.map((part, index) =>
                      /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)(
                        'span',
                        {
                          style: {
...
const $7390fd757b2ce4b0$var$MarkerClusterGroup = (0, $CiwlJ$reactleafletcore.createPathComponent)(
  $7390fd757b2ce4b0$var$createMarkerCluster
);
  ...
  return /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsxs)((0, $CiwlJ$reactjsxruntime.Fragment), {
    children: [
      ...
      resourceDefinition.hasShow &&
        /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $CiwlJ$reactadmin.ShowButton), {}),
    ...
    children: /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsxs)((0, $CiwlJ$muimaterial.Box), {
      ...
      children: [
        /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $CiwlJ$muimaterial.IconButton), {
          ...
          size: 'large',
          children: /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)(
            (0, $parcel$interopDefault($CiwlJ$muiiconsmaterialClear)),
            {}
          )
        }),
...
const $3929b9df2dd76406$var$MapList = ({
  latitude: latitude,
  longitude: longitude,
  label: label,
  ...
  const markers = records.map((record, i) => {
    const marker = /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsxs)(
      (0, $parcel$interopDefault($CiwlJ$react)).Fragment,
      {
        children: [
          /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $CiwlJ$reactleaflet.Marker), {
            ...
            children:
              !xs &&
              /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $CiwlJ$reactleaflet.Popup), {
          ...
          connectMarkers &&
            previousRecord &&
            /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $CiwlJ$reactleaflet.Polyline), {
              positions: [
  ...
  return /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsxs)((0, $CiwlJ$reactleaflet.MapContainer), {
    ...
    children: [
      ...
      isLoading &&
        /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $CiwlJ$muimaterial.Box), {
          alignItems: 'center',
          className: classes.isLoading,
          children: /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)(
            (0, $parcel$interopDefault($CiwlJ$muimaterialCircularProgress)),
            {
              size: 60,
              thickness: 6
            }
      ...
      groupClusters
        ? /*#__PURE__*/ (0, $CiwlJ$reactjsxruntime.jsx)((0, $7390fd757b2ce4b0$export$2e2bcd8739ae039), {
...
const $7855b7e2551c6d96$var$MapField = ({
  latitude: latitude,
  longitude: longitude,
  address: address,
  height: height,
