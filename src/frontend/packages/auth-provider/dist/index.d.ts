...
import { CreateProps, EditProps, ToolbarProps, ListActionsProps, ListProps, ShowProps } from "react-admin";
...
export const CreateWithPermissions: ({ actions, children, ...rest }: PropsWithChildren<CreateProps>) => import("react/jsx-runtime").JSX.Element;
...
export const EditWithPermissions: ({ actions, children, ...rest }: PropsWithChildren<EditProps>) => import("react/jsx-runtime").JSX.Element;
...
export const ListActionsWithPermissions: ({ sort, displayedFilters, exporter, filters, filterValues, showFilter, total }: ListActionsProps) => import("react/jsx-runtime").JSX.Element;
export const ListWithPermissions: ({ actions, ...rest }: ListProps) => import("react/jsx-runtime").JSX.Element;
export const ShowActionsWithPermissions: () => import("react/jsx-runtime").JSX.Element;
export const ShowWithPermissions: ({ actions, ...rest }: ShowProps) => import("react/jsx-runtime").JSX.Element;
 ...
 * @returns
 */
export function LocalLoginPage({ hasSignup, allowUsername, onLogin, onSignup, additionalSignupValues, passwordScorer }: {
    hasSignup: boolean;
