      ...
      switch (authType) {
        ...
        case $6a92eb32301846ac$var$AUTH_TYPE_SSO: {
          ...
          return (0, $parcel$interopDefault($4Uj5b$urljoin))(
            authServerUrl,
            `auth/logout?redirectUrl=${encodeURIComponent(`${(0, $parcel$interopDefault($4Uj5b$urljoin))(baseUrl, 'login')}?logout=true`)}`
          );
        }
 ...
 * @returns
 */ const $87a1f23cb4681f00$var$SignupForm = ({
...
const $87a1f23cb4681f00$var$FormContent = ({
  passwordScorer: passwordScorer = (0, $d1ca1e1d215e32ca$export$19dcdb21c6965fb8),
  onSignup: onSignup,
  additionalSignupValues: additionalSignupValues,
  delayBeforeRedirect: delayBeforeRedirect = 0,
  ...
  return /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsxs)((0, $4Uj5b$muimaterial.CardContent), {
    children: [
      ...
      /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$reactadmin.TextInput), {
        ...
        validate: [(0, $4Uj5b$reactadmin.required)('auth.required.email'), (0, $4Uj5b$reactadmin.email)()]
      }),
      passwordScorer &&
        password &&
        ...
        children: [
          ...
          /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$muimaterial.IconButton), {
            ...
            children: showPassword
              ? /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$muiiconsmaterial.VisibilityOff), {})
              : /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$muiiconsmaterial.Visibility), {})
          })
        ]
      }),
      /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$muimaterial.Button), {
...
const $403a8b015c5eea65$var$FormContent = ({
  onLogin: onLogin,
  allowUsername: allowUsername,
  setHandleSubmit: setHandleSubmit
}) => {
    ...
    children: [
      /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$reactadmin.TextInput), {
        ...
        validate: allowUsername
          ? [(0, $4Uj5b$reactadmin.required)(translate('auth.required.identifier'))]
          : [(0, $4Uj5b$reactadmin.required)(translate('auth.required.identifier')), (0, $4Uj5b$reactadmin.email)()]
      }),
      /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsxs)('div', {
        className: 'password-container',
        style: {
 ...
 *  passwordStrength's `defaultScorer`.
 * @returns
 */ const $2f0ce992717e175e$var$NewPasswordForm = ({
...
const $2f0ce992717e175e$var$FormContent = ({
  setHandleSubmit: setHandleSubmit,
  redirectTo: redirectTo,
  passwordScorer: passwordScorer
}) => {
      ...
      /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsxs)('div', {
        ...
        children: [
          /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$reactadmin.TextInput), {
            ...
            fullWidth: true,
            disabled: loading,
            validate: [(0, $4Uj5b$reactadmin.required)(), $2f0ce992717e175e$var$samePassword],
 ...
 */ const $4c56dbfbda0fa20c$var$LocalLoginPage = ({
  ...
  return /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $d6b5c702311394c4$export$2e2bcd8739ae039), {
    ...
    children: /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsxs)((0, $4Uj5b$muimaterial.Card), {
      children: [
        isLogin &&
          /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $403a8b015c5eea65$export$2e2bcd8739ae039), {
            onLogin: onLogin,
            allowUsername: allowUsername
          }),
        isSignup &&
          /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $87a1f23cb4681f00$export$2e2bcd8739ae039), {
        ...
        isResetPassword &&
          /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $be1129164d40878e$export$2e2bcd8739ae039), {}),
        isNewPassword &&
          /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $2f0ce992717e175e$export$2e2bcd8739ae039), {
            redirectTo: redirectTo,
            passwordScorer: passwordScorer
          }),
        /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsxs)((0, $4Uj5b$muimaterial.Box), {
