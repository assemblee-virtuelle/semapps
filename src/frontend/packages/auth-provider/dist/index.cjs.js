  ...
  return {
      ...
      if (authType === $6a92eb32301846ac$var$AUTH_TYPE_LOCAL) {
        ...
        try {
          const { json: json } = await dataProvider.fetch(
            (0, $parcel$interopDefault($4Uj5b$urljoin))(authServerUrl, 'auth/login'),
            {
              method: 'POST',
              body: JSON.stringify({
    ...
    signup: async params => {
      ...
      if (authType === $6a92eb32301846ac$var$AUTH_TYPE_LOCAL) {
        ...
        try {
          const { json: json } = await dataProvider.fetch(
            (0, $parcel$interopDefault($4Uj5b$urljoin))(authServerUrl, 'auth/signup'),
            {
              method: 'POST',
              body: JSON.stringify({
                username: username.trim(),
...
const $09162138eadab4b9$export$22242524f7d0624 = [$09162138eadab4b9$export$5581cb2c55de143a];
...
const $673a0cc190160362$var$useCheckPermissions = (uri, mode, redirectUrl = '/') => {
  ...
  (0, $4Uj5b$react.useEffect)(() => {
    if (
      ...
      identity &&
      permissions &&
      !permissions.some(p => (0, $09162138eadab4b9$export$cae945d60b6cbe50)[mode].includes(p['acl:mode']))
    ) {
...
const $a613ad42a03b1bc4$var$AddPermissionsForm = ({ agents: agents, addPermission: addPermission }) => {
  ...
  return /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $parcel$interopDefault($4Uj5b$muimaterialAutocomplete)), {
    ...
    onChange: (event, record) => {
      addPermission(
        record.id || record['@id'],
        (0, $09162138eadab4b9$export$97a08a1bb7ee0545),
        (0, $09162138eadab4b9$export$66a34090010a35b3)
      );
      setValue(null);
      setInputValue('');
      setOptions([]);
...
const $9f58b72d42a695d9$var$AgentIcon = ({ agent: agent }) => {
  switch (agent.predicate) {
    case (0, $09162138eadab4b9$export$2703254089a859eb):
      return agent.id === (0, $09162138eadab4b9$export$83ae1bc0992a6335)
...
const $7a8c6187e6c69fdd$var$AgentItem = ({
  ...
  (0, $4Uj5b$react.useEffect)(() => {
    if (agent.predicate === (0, $09162138eadab4b9$export$97a08a1bb7ee0545))
      dataProvider
        .getOne('Person', {
          id: agent.id
        })
  ...
  const labels = isContainer
    ? (0, $09162138eadab4b9$export$edca379024d80309)
    : (0, $09162138eadab4b9$export$2e9571c4ccdeb6a9);
    ...
    children: [
      ...
      /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$muimaterial.ListItemText), {
        ...
        primary: user
          ? user['pair:label']
          : translate(
              agent.id === (0, $09162138eadab4b9$export$83ae1bc0992a6335)
  ...
  (0, $4Uj5b$react.useEffect)(() => {
    ...
    if (permissions) {
      for (const p of permissions) {
        if (p[(0, $09162138eadab4b9$export$2703254089a859eb)])
          (0, $2d06940433ec0c6c$export$dca4f48302963835)(p[(0, $09162138eadab4b9$export$2703254089a859eb)]).forEach(
            agentId => appendPermission(agentId, (0, $09162138eadab4b9$export$2703254089a859eb), p['acl:mode'])
          );
        if (p[(0, $09162138eadab4b9$export$97a08a1bb7ee0545)])
          (0, $2d06940433ec0c6c$export$dca4f48302963835)(p[(0, $09162138eadab4b9$export$97a08a1bb7ee0545)]).forEach(
            userUri => appendPermission(userUri, (0, $09162138eadab4b9$export$97a08a1bb7ee0545), p['acl:mode'])
          );
        if (p[(0, $09162138eadab4b9$export$f07ccbe0773f2c7)])
          (0, $2d06940433ec0c6c$export$dca4f48302963835)(p[(0, $09162138eadab4b9$export$f07ccbe0773f2c7)]).forEach(
            groupUri => appendPermission(groupUri, (0, $09162138eadab4b9$export$f07ccbe0773f2c7), p['acl:mode'])
          );
      }
      setAgents(result);
    }
      ...
      setAgents(
        Object.fromEntries(
          Object.entries(agents)
            ...
            .filter(
              ([_, agent]) =>
                agent.predicate === (0, $09162138eadab4b9$export$2703254089a859eb) || agent.permissions.length > 0
            )
        )
      );
...
const $4076d0aea1b9e239$var$EditActionsWithPermissions = () => {
  ...
  return /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsxs)((0, $4Uj5b$reactadmin.TopToolbar), {
    children: [
      ...
      !!permissions &&
        permissions.some(p => (0, $09162138eadab4b9$export$22242524f7d0624).includes(p['acl:mode'])) &&
...
const $79bac4913d414938$var$DeleteButtonWithPermissions = props => {
  ...
  if (!isLoading && permissions?.some(p => (0, $09162138eadab4b9$export$ac7b0367c0f9031e).includes(p['acl:mode'])))
...
const $496e40eed9f00a2c$var$EditButtonWithPermissions = props => {
  const recordId = (0, $4Uj5b$reactadmin.useGetRecordId)();
  const { permissions: permissions, isLoading: isLoading } = (0, $4Uj5b$reactadmin.usePermissions)(recordId);
  if (!isLoading && permissions?.some(p => (0, $09162138eadab4b9$export$b9d0f5f3ab5e453b).includes(p['acl:mode'])))
  ...
  return /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsxs)((0, $4Uj5b$reactadmin.TopToolbar), {
    children: [
      ...
      resourceDefinition.hasCreate &&
        permissions &&
        permissions.some(p => (0, $09162138eadab4b9$export$65615a101bd6f5ca).includes(p['acl:mode'])) &&
...
const $83b0bd683a7f3aa8$var$ShowActionsWithPermissions = () => {
  ...
  return /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsxs)((0, $4Uj5b$reactadmin.TopToolbar), {
    children: [
      ...
      hasEdit &&
        permissions &&
        permissions.some(p => (0, $09162138eadab4b9$export$b9d0f5f3ab5e453b).includes(p['acl:mode'])) &&
          ...
          setTimeout(() => {
            ...
            window.location.href = postSignupRedirect
              ? `${postSignupRedirect}?redirect=${encodeURIComponent(redirectTo || '/')}${(0,
                $cd7709c431b14d14$export$2e2bcd8739ae039)(searchParams)}`
              : redirectTo || '/';
            setLoading(false);
          }, delayBeforeRedirect);
        else {
...
const $0973974d3aa8078b$var$ResourceWithPermission = ({ name: name, create: create, ...rest }) => {
  ...
  return /*#__PURE__*/ (0, $4Uj5b$reactjsxruntime.jsx)((0, $4Uj5b$reactadmin.Resource), {
    ...
    name: name,
    create:
      permissions && permissions.some(p => (0, $09162138eadab4b9$export$65615a101bd6f5ca).includes(p['acl:mode']))
        ? create
        : undefined
  });
};
