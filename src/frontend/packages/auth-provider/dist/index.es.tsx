...
const $ee80a6b397c7131d$export$dca4f48302963835 = (value: any) => !value ? undefined : Array.isArray(value) ? value : [
        value
    ];
...
const $ee80a6b397c7131d$export$1391212d75b2ee65 = async (t: any) => new Promise((resolve)=>{
        setTimeout(resolve, t);
    });
const $ee80a6b397c7131d$export$bab98af026af71ac = (value: any) => typeof value === 'string' && value.startsWith('http') && !/\s/g.test(value);
const $ee80a6b397c7131d$export$50ae7fb6f87de989 = (value: any) => typeof value === 'string' && value.startsWith('/') && !/\s/g.test(value);
...
const $1d8606895ce3b768$var$authProvider = ({ dataProvider: dataProvider, authType: authType, allowAnonymous: allowAnonymous = true, checkUser: checkUser, checkPermissions: checkPermissions = false, clientId: clientId })=>{
    ...
    return {
        ...
        removePermission: async (uri: any, agentId: any, predicate: any, mode: any)=>{
            ...
            const { json: json } = await dataProvider.fetch(aclUri);
            const updatedPermissions = json['@graph'].filter((authorization: any) => !authorization['@id'].includes('#Default')).map((authorization: any) => {
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
...
const $3246c5a1f284b82d$var$useCheckPermissions = (uri: any, mode: any, redirectUrl = '/')=>{
    ...
    (0, $1obPJ$useEffect)(()=>{
        // @ts-expect-error TS(7053): Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        if (permissions && !permissions.some((p: any) => (0, $dd9154ee844248d7$export$cae945d60b6cbe50)[mode].includes(p['acl:mode']))) {
            // @ts-expect-error TS(7053): Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
...
const $38698ff0e415f88b$var$AddPermissionsForm = ({ agents: agents, addPermission: addPermission })=>{
    ...
    return (
        ...
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$muimaterialAutocomplete), {
            ...
            // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
            renderInput: (params: any) => /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextField), {
                    ...params,
            ...
            // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
            renderOption: (props: any, option: any)=>/*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$List), {
                    dense: true,
...
const $7ad577d9c9c71db0$var$useAgents = (uri: any) => {
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const addPermission = (0, $1obPJ$useCallback)((agentId: any, predicate: any, mode: any)=>{
        const prevAgents = {
            ...agents
        };
        setAgents({
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const removePermission = (0, $1obPJ$useCallback)((agentId: any, predicate: any, mode: any)=>{
        const prevAgents = {
            ...agents
        };
...
const $1d084bfeb799eb8d$var$EditActionsWithPermissions = ()=>{
    ...
    return (
        ...
        /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
            children: [
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                hasList && containerPermissions && containerPermissions.some((p: any) => (0, $dd9154ee844248d7$export$dc3840a4e2a72b8c).includes(p['acl:mode'])) && /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$ListButton), {}),
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                hasShow && permissions && permissions.some((p: any) => (0, $dd9154ee844248d7$export$d37f0098bcf84c55).includes(p['acl:mode'])) && /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$ShowButton), {}),
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                permissions && permissions.some((p: any) => (0, $dd9154ee844248d7$export$22242524f7d0624).includes(p['acl:mode'])) && /*#__PURE__*/ (0, $1obPJ$jsx)((0, $7dac2771cc5eb38b$export$2e2bcd8739ae039), {})
            ]
        })
    );
};
...
const $7efdcbe4be05bfd5$var$DeleteButtonWithPermissions = (props: any) => {
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    if (!isLoading && permissions?.some((p: any) => (0, $dd9154ee844248d7$export$ac7b0367c0f9031e).includes(p['acl:mode']))) return /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$DeleteButton), {
        ...props
    });
    return null;
};
...
// @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
const $6b0c1a175ed94bdf$var$EditToolbarWithPermissions = (props: any) => /*#__PURE__*/ (0, $1obPJ$jsxs)($6b0c1a175ed94bdf$var$StyledToolbar, {
        ...props,
        children: [
            // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
...
const $c78c2d7e17f60b2f$var$EditButtonWithPermissions = (props: any) => {
    ...
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    if (!isLoading && permissions?.some((p: any) => (0, $dd9154ee844248d7$export$b9d0f5f3ab5e453b).includes(p['acl:mode']))) return /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$EditButton), {
        ...props
    });
    return null;
};
    ...
    return (
        ...
        /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
            children: [
                ...
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                resourceDefinition.hasCreate && permissions?.some((p: any) => (0, $dd9154ee844248d7$export$65615a101bd6f5ca).includes(p['acl:mode'])) && /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$CreateButton), {}),
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                permissions?.some((p: any) => (0, $dd9154ee844248d7$export$22242524f7d0624).includes(p['acl:mode'])) && /*#__PURE__*/ (0, $1obPJ$jsx)((0, $7dac2771cc5eb38b$export$2e2bcd8739ae039), {
                    isContainer: true
                }),
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    ...
    return (
        ...
        /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
            children: [
                ...
                hasList && containerPermissions && containerPermissions.some((p: any) => (0, $dd9154ee844248d7$export$dc3840a4e2a72b8c).includes(p['acl:mode'])) && /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$ListButton), {}),
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                hasEdit && permissions && permissions.some((p: any) => (0, $dd9154ee844248d7$export$b9d0f5f3ab5e453b).includes(p['acl:mode'])) && /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$EditButton), {}),
                // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                permissions && permissions.some((p: any) => (0, $dd9154ee844248d7$export$22242524f7d0624).includes(p['acl:mode'])) && /*#__PURE__*/ (0, $1obPJ$jsx)((0, $7dac2771cc5eb38b$export$2e2bcd8739ae039), {})
            ]
        })
        ...
        /*#__PURE__*/ (0, $1obPJ$jsx)($479961b7e298304b$var$Root, {
            ...
            children: /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$Card), {
                ...
                children: [
                    ...
                    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                    buttons?.map((button: any, i: any)=>/*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$CardActions), {
                            // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
...
const $646d64648a630b24$export$b6086dad7504ebad = (password: any, options = $646d64648a630b24$export$ba43bf67f3d48107)=>{
    const mergedOptions = {
        ...$646d64648a630b24$export$ba43bf67f3d48107,
        ...options
    };
...
// @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
const $7a0bbe6824860dfe$var$validatePasswordStrength = (scorer = (0, $646d64648a630b24$export$19dcdb21c6965fb8))=>(value: any) => {
 ...
 * @returns
 // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
 */ const $abd712f6afb101e7$var$SignupForm = ({ passwordScorer: passwordScorer = (0, $646d64648a630b24$export$19dcdb21c6965fb8), onSignup: onSignup, additionalSignupValues: additionalSignupValues = {}, delayBeforeRedirect: delayBeforeRedirect = 0, redirectTo: redirectTo })=>{
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
    const [searchParams] = (0, $1obPJ$useSearchParams)();
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
...
// @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
const $abd712f6afb101e7$var$FormContent = ({ passwordScorer: passwordScorer = (0, $646d64648a630b24$export$19dcdb21c6965fb8), onSignup: onSignup, additionalSignupValues: additionalSignupValues, delayBeforeRedirect: delayBeforeRedirect = 0, setHandleSubmit: setHandleSubmit, redirectTo: redirectTo })=>{
    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
        ...
        /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$CardContent), {
            children: [
                ...
                /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
                    ...
                    // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
                    format: (value: any) => value ? (0, $1obPJ$speakingurl)(value, {
                            lang: locale || 'fr',
                            separator: '_',
                            custom: [
                                '.',
...
const $9594dfbc217337d0$var$ResourceWithPermission = ({ name: name, create: create, ...rest })=>{
    ...
    return (
        ...
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$Resource), {
            ...
            name: name,
            // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
            create: permissions && permissions.some((p: any) => (0, $dd9154ee844248d7$export$65615a101bd6f5ca).includes(p['acl:mode'])) ? create : undefined
        })
    );
};
