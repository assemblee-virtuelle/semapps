...
import {
  ...
  usePermissionsOptimized as $1obPJ$usePermissionsOptimized,
    ...
    logout: async () => {
      switch (authType) {
        case $1d8606895ce3b768$var$AUTH_TYPE_LOCAL: {
          ...
          localStorage.clear();
          const { status: status, json: oidcConfig } = await dataProvider.fetch(
            (0, $1obPJ$urljoin)(authServerUrl, '.well-known/openid-configuration')
          );
          if (status === 200)
...
const $3ecc2efd72c45a68$export$22242524f7d0624 = [$3ecc2efd72c45a68$export$5581cb2c55de143a];
...
const $abd69a52484f41d9$var$useCheckPermissions = (uri, mode, redirectUrl = '/') => {
  ...
  (0, $1obPJ$useEffect)(() => {
    if (
      ...
      identity &&
      permissions &&
      !permissions.some(p => (0, $3ecc2efd72c45a68$export$cae945d60b6cbe50)[mode].includes(p['acl:mode']))
    ) {
...
const $38698ff0e415f88b$var$AddPermissionsForm = ({ agents: agents, addPermission: addPermission }) => {
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$muimaterialAutocomplete), {
    ...
    onChange: (event, record) => {
      addPermission(
        record.id || record['@id'],
        (0, $3ecc2efd72c45a68$export$97a08a1bb7ee0545),
        (0, $3ecc2efd72c45a68$export$66a34090010a35b3)
      );
      setValue(null);
      setInputValue('');
      setOptions([]);
...
const $2a38cfa58fd59a9e$var$AgentIcon = ({ agent: agent }) => {
  switch (agent.predicate) {
    case (0, $3ecc2efd72c45a68$export$2703254089a859eb):
      return agent.id === (0, $3ecc2efd72c45a68$export$83ae1bc0992a6335)
...
const $e8b8e6301988112e$var$AgentItem = ({
  ...
  (0, $1obPJ$useEffect)(() => {
    if (agent.predicate === (0, $3ecc2efd72c45a68$export$97a08a1bb7ee0545))
      dataProvider
        .getOne('Person', {
          id: agent.id
        })
  ...
  const labels = isContainer
    ? (0, $3ecc2efd72c45a68$export$edca379024d80309)
    : (0, $3ecc2efd72c45a68$export$2e9571c4ccdeb6a9);
    ...
    children: [
      ...
      /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$ListItemText), {
        ...
        primary: user
          ? user['pair:label']
          : translate(
              agent.id === (0, $3ecc2efd72c45a68$export$83ae1bc0992a6335)
  ...
  (0, $1obPJ$useEffect)(() => {
    ...
    if (permissions) {
      for (const p of permissions) {
        if (p[(0, $3ecc2efd72c45a68$export$2703254089a859eb)])
          (0, $47a3fad69bcb0083$export$dca4f48302963835)(p[(0, $3ecc2efd72c45a68$export$2703254089a859eb)]).forEach(
            agentId => appendPermission(agentId, (0, $3ecc2efd72c45a68$export$2703254089a859eb), p['acl:mode'])
          );
        if (p[(0, $3ecc2efd72c45a68$export$97a08a1bb7ee0545)])
          (0, $47a3fad69bcb0083$export$dca4f48302963835)(p[(0, $3ecc2efd72c45a68$export$97a08a1bb7ee0545)]).forEach(
            userUri => appendPermission(userUri, (0, $3ecc2efd72c45a68$export$97a08a1bb7ee0545), p['acl:mode'])
          );
        if (p[(0, $3ecc2efd72c45a68$export$f07ccbe0773f2c7)])
          (0, $47a3fad69bcb0083$export$dca4f48302963835)(p[(0, $3ecc2efd72c45a68$export$f07ccbe0773f2c7)]).forEach(
            groupUri => appendPermission(groupUri, (0, $3ecc2efd72c45a68$export$f07ccbe0773f2c7), p['acl:mode'])
          );
      }
      setAgents(result);
    }
      ...
      setAgents(
        Object.fromEntries(
          Object.entries(agents)
            ...
            .filter(
              ([_, agent]) =>
                agent.predicate === (0, $3ecc2efd72c45a68$export$2703254089a859eb) || agent.permissions.length > 0
            )
        )
      );
...
const $62be5dcee9954341$var$EditActionsWithPermissions = () => {
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
    children: [
      ...
      !!permissions &&
        permissions.some(p => (0, $3ecc2efd72c45a68$export$22242524f7d0624).includes(p['acl:mode'])) &&
...
const $7efdcbe4be05bfd5$var$DeleteButtonWithPermissions = props => {
  ...
  if (!isLoading && permissions?.some(p => (0, $3ecc2efd72c45a68$export$ac7b0367c0f9031e).includes(p['acl:mode'])))
...
const $c78c2d7e17f60b2f$var$EditButtonWithPermissions = props => {
  const recordId = (0, $1obPJ$useGetRecordId)();
  const { permissions: permissions, isLoading: isLoading } = (0, $1obPJ$usePermissions)(recordId);
  if (!isLoading && permissions?.some(p => (0, $3ecc2efd72c45a68$export$b9d0f5f3ab5e453b).includes(p['acl:mode'])))
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
    children: [
      ...
      resourceDefinition.hasCreate &&
        permissions &&
        permissions.some(p => (0, $3ecc2efd72c45a68$export$65615a101bd6f5ca).includes(p['acl:mode'])) &&
...
const $d1f54fc03225e8ee$var$ShowActionsWithPermissions = () => {
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
    children: [
      ...
      hasEdit &&
        permissions &&
        permissions.some(p => (0, $3ecc2efd72c45a68$export$b9d0f5f3ab5e453b).includes(p['acl:mode'])) &&
  ...
  (0, $1obPJ$useEffect)(() => {
    if (!isLoading && identity?.id) {
      if (postLoginRedirect)
        navigate(`${postLoginRedirect}?${(0, $2dfd781b793256e6$export$2e2bcd8739ae039)(searchParams)}`);
...
const $9594dfbc217337d0$var$ResourceWithPermission = ({ name: name, create: create, ...rest }) => {
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$Resource), {
    ...
    name: name,
    create:
      permissions && permissions.some(p => (0, $3ecc2efd72c45a68$export$65615a101bd6f5ca).includes(p['acl:mode']))
        ? create
        : undefined
  });
};
...
export {
  ...
  $62be5dcee9954341$export$2e2bcd8739ae039 as EditActionsWithPermissions,
  ...
  $d1f54fc03225e8ee$export$2e2bcd8739ae039 as ShowActionsWithPermissions,
  ...
  $abd69a52484f41d9$export$2e2bcd8739ae039 as useCheckPermissions,
