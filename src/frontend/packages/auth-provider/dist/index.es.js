...
import {
  useCreateContainerUri as $1obPJ$useCreateContainerUri,
  useCreateContainer as $1obPJ$useCreateContainer
...
import {
  ...
  CircularProgress as $1obPJ$CircularProgress,
  ...
  return {
    login: async params => {
      if (authType === $1d8606895ce3b768$var$AUTH_TYPE_SOLID_OIDC) {
        ...
        webId && issuer;
        const as = await $1obPJ$discoveryRequest(new URL(issuer)).then(response =>
          $1obPJ$processDiscoveryResponse(new URL(issuer), response)
        );
 ...
 * @returns
 */ const $e011da92680cf1fe$var$SignupForm = ({
  ...
  const redirectTo = postSignupRedirect
    ? `${postSignupRedirect}?${(0, $2dfd781b793256e6$export$2e2bcd8739ae039)(searchParams)}`
    : searchParams.get('redirect') || '/';
  const [locale] = (0, $1obPJ$useLocaleState)();
  const [password, setPassword] = (0, $1obPJ$useState)('');
  const submit = (0, $1obPJ$useCallback)(
    async values => {
      try {
        setLoading(true);
        await signup({
    ...
    children: /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$CardContent), {
      ...
      children: [
        ...
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
          ...
          validate: [(0, $1obPJ$required)(), (0, $1obPJ$email)()]
        }),
        passwordScorer &&
          password &&
        ...
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
          ...
          fullWidth: true,
          disabled: loading || (searchParams.has('email') && searchParams.has('force-email')),
          validate: [(0, $1obPJ$required)(), (0, $7a0bbe6824860dfe$export$2e2bcd8739ae039)(passwordScorer)]
        }),
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$Button1), {
          variant: 'contained',
          type: 'submit',
          ...
          children: loading
            ? /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$CircularProgress), {
...
const $e2a34b2d647a5391$var$LoginForm = ({ postLoginRedirect: postLoginRedirect, allowUsername: allowUsername }) => {
  ...
  const redirectTo = postLoginRedirect
    ? `${postLoginRedirect}?${(0, $2dfd781b793256e6$export$2e2bcd8739ae039)(searchParams)}`
    : searchParams.get('redirect');
  const submit = (0, $1obPJ$useCallback)(
    async values => {
      try {
    ...
    children: /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$CardContent), {
      ...
      children: [
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
          ...
          validate: allowUsername ? [(0, $1obPJ$required)()] : [(0, $1obPJ$required)(), (0, $1obPJ$email)()]
        }),
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
          source: 'password',
          type: 'password',
 ...
 *  passwordStrength's `defaultScorer`.
 * @returns
 */ const $b403c35bd8d76c50$var$NewPasswordForm = ({
    ...
    children: /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$CardContent), {
      ...
      children: [
        ...
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
          ...
          fullWidth: true,
          disabled: loading,
          validate: [(0, $1obPJ$required)(), $b403c35bd8d76c50$var$samePassword]
        }),
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$Button1), {
          variant: 'contained',
          type: 'submit',
 ...
 */ const $23fea069f5d2d834$var$LocalLoginPage = ({
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1b78e27e3e92a798$export$2e2bcd8739ae039), {
    ...
    children: /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$Card), {
      children: [
        isSignup &&
          /*#__PURE__*/ (0, $1obPJ$jsx)((0, $e011da92680cf1fe$export$2e2bcd8739ae039), {
        ...
        isNewPassword &&
          /*#__PURE__*/ (0, $1obPJ$jsx)((0, $b403c35bd8d76c50$export$2e2bcd8739ae039), {
            redirectTo: redirectTo,
            passwordScorer: passwordScorer
          }),
        isLogin &&
          /*#__PURE__*/ (0, $1obPJ$jsx)((0, $e2a34b2d647a5391$export$2e2bcd8739ae039), {
            postLoginRedirect: postLoginRedirect,
            allowUsername: allowUsername
          }),
