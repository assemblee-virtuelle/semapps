...
const $47a3fad69bcb0083$export$dca4f48302963835 = value =>
      ...
      switch (authType) {
        ...
        case $1d8606895ce3b768$var$AUTH_TYPE_POD: {
          ...
          if (token) {
            ...
            return `${(0, $1obPJ$urljoin)(webId, 'openApp')}?type=${encodeURIComponent(
...
const $3246c5a1f284b82d$var$useCheckPermissions = (uri, mode, redirectUrl = '/') => {
  ...
  (0, $1obPJ$useEffect)(() => {
    if (
      permissions &&
      !permissions.some(p => (0, $dd9154ee844248d7$export$cae945d60b6cbe50)[mode].includes(p['acl:mode']))
    ) {
    ...
    if (permissions) {
      for (const p of permissions) {
        if (p[(0, $dd9154ee844248d7$export$2703254089a859eb)])
          (0, $47a3fad69bcb0083$export$dca4f48302963835)(p[(0, $dd9154ee844248d7$export$2703254089a859eb)]).forEach(
        ...
        if (p[(0, $dd9154ee844248d7$export$97a08a1bb7ee0545)])
          (0, $47a3fad69bcb0083$export$dca4f48302963835)(p[(0, $dd9154ee844248d7$export$97a08a1bb7ee0545)]).forEach(
        ...
        if (p[(0, $dd9154ee844248d7$export$f07ccbe0773f2c7)])
          (0, $47a3fad69bcb0083$export$dca4f48302963835)(p[(0, $dd9154ee844248d7$export$f07ccbe0773f2c7)]).forEach(
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
    children: [
      hasList &&
        ...
        containerPermissions.some(p => (0, $dd9154ee844248d7$export$dc3840a4e2a72b8c).includes(p['acl:mode'])) &&
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$ListButton), {}),
      hasShow &&
        permissions &&
        permissions.some(p => (0, $dd9154ee844248d7$export$d37f0098bcf84c55).includes(p['acl:mode'])) &&
        /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$ShowButton), {}),
      permissions &&
        permissions.some(p => (0, $dd9154ee844248d7$export$22242524f7d0624).includes(p['acl:mode'])) &&
...
const $7efdcbe4be05bfd5$var$DeleteButtonWithPermissions = props => {
  ...
  if (!isLoading && permissions?.some(p => (0, $dd9154ee844248d7$export$ac7b0367c0f9031e).includes(p['acl:mode'])))
...
const $6b0c1a175ed94bdf$var$EditToolbarWithPermissions = props =>
...
const $c78c2d7e17f60b2f$var$EditButtonWithPermissions = props => {
  const recordId = (0, $1obPJ$useGetRecordId)();
  const { permissions: permissions, isLoading: isLoading } = (0, $1obPJ$usePermissions)(recordId);
  if (!isLoading && permissions?.some(p => (0, $dd9154ee844248d7$export$b9d0f5f3ab5e453b).includes(p['acl:mode'])))
...
const $e6071424a1ba88d9$var$ListActionsWithPermissions = ({
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
    children: [
      ...
      resourceDefinition.hasCreate &&
        permissions &&
        permissions.some(p => (0, $dd9154ee844248d7$export$65615a101bd6f5ca).includes(p['acl:mode'])) &&
      ...
      bulkActions &&
        /*#__PURE__*/ (0, $1obPJ$react).cloneElement(bulkActions, {
          filterValues: filterValues,
          selectedIds: selectedIds,
          onUnselectItems: onUnselectItems
        })
...
const $a4ded8260cc90dad$var$ListWithPermissions = props =>
...
const $acd67d211d146755$var$ShowActionsWithPermissions = () => {
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$TopToolbar), {
    children: [
      ...
      hasEdit &&
        permissions &&
        permissions.some(p => (0, $dd9154ee844248d7$export$b9d0f5f3ab5e453b).includes(p['acl:mode'])) &&
...
const $646d64648a630b24$export$b6086dad7504ebad = (password, options = $646d64648a630b24$export$ba43bf67f3d48107) => {
  const mergedOptions = {
    ...$646d64648a630b24$export$ba43bf67f3d48107,
    ...options
  };
...
const $646d64648a630b24$export$a1d713a9155d58fc = (
  ...
  return {
    ...
    analyzeFn: password => $646d64648a630b24$export$b6086dad7504ebad(password, mergedOptions),
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsxs)((0, $1obPJ$CardContent), {
    children: [
      /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
        ...
        fullWidth: true,
        disabled: loading,
        validate: [(0, $1obPJ$required)(translate('auth.required.identifier')), (0, $1obPJ$minLength)(2)],
        format: value =>
          value
      ...
      /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
        ...
        validate: [(0, $1obPJ$required)('auth.required.email'), (0, $1obPJ$email)()]
      }),
      passwordScorer &&
        password &&
    ...
    children: [
      /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
        ...
        validate: allowUsername
          ...
          : [(0, $1obPJ$required)(translate('auth.required.identifier')), (0, $1obPJ$email)()]
      }),
      /*#__PURE__*/ (0, $1obPJ$jsxs)('div', {
        className: 'password-container',
        style: {
      ...
      /*#__PURE__*/ (0, $1obPJ$jsxs)('div', {
        ...
        children: [
          /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$TextInput), {
            ...
            fullWidth: true,
            disabled: loading,
            validate: [(0, $1obPJ$required)(), $ddc5b4ef9210a90f$var$samePassword],
...
const $9594dfbc217337d0$var$ResourceWithPermission = ({ name: name, create: create, ...rest }) => {
  ...
  return /*#__PURE__*/ (0, $1obPJ$jsx)((0, $1obPJ$Resource), {
    ...
    name: name,
    create:
      permissions && permissions.some(p => (0, $dd9154ee844248d7$export$65615a101bd6f5ca).includes(p['acl:mode']))
        ? create
        : undefined
  });
};
...
export {
  ...
  $f2c5683e04dee28c$export$2e2bcd8739ae039 as CreateWithPermissions,
  $28fa6ad821327921$export$2e2bcd8739ae039 as EditWithPermissions,
  ...
  $a4ded8260cc90dad$export$2e2bcd8739ae039 as ListWithPermissions,
  $e6071424a1ba88d9$export$2e2bcd8739ae039 as ListActionsWithPermissions,
  $561bb436d5af917c$export$2e2bcd8739ae039 as ShowWithPermissions,
