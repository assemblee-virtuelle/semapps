...
public class ShiroEvaluator implements SecurityEvaluator {
	 ...
	 * and pass the header X-SemappsUser with value "system" or the URI of a user with corresponding permissions
	 * @param principalObj
	 * @param r
	 * @return
	 */
	private boolean evaluate( Object principalObj, Resource r )
	{
		...
		LOG.info( "checking {}", subject.getPrincipal());
		...
		// TODO : default policy (deny all / accept all) should be set by env variable or header
