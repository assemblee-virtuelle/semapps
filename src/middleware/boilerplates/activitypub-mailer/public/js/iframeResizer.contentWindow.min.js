...
!(function(d) {
      ...
      _ =
        ...
        function() {
          ...
          return (
            ...
            (K = arguments),
            t <= 0 || R < t
              ? (X && (clearTimeout(X), (X = null)), (Y = e), (Q = U.apply(V, K)), X || (V = K = null))
              : (X = X || setTimeout(Ee, t)),
            Q
          );
        });
      ...
      (P.parentIFrame = {
        autoResize: function(e) {
          return (
            !0 === e && !1 === n
              ? ((n = !0), he())
              : !1 === e && !0 === n && ((n = !1), de('remove'), null !== t && t.disconnect(), clearInterval(w)),
      ...
      (y = (function() {
        ...
        y.enable
          ? Array.prototype.forEach && document.querySelectorAll
            ? (ie('Setting up location.hash handlers'), n(), te(window, 'hashchange', e), setTimeout(e, l))
  ...
  function Ne(e, t, n, o, i) {
    ...
    !0 === N &&
      ...
      ie('Sending message to host page (' + (r = S + ':' + (e + ':' + t) + ':' + n + (d !== o ? ':' + o : '')) + ')'),
      A.postMessage(E + r, i));
  }
  function Ae() {
