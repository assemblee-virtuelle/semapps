...
declare global {
  export namespace Moleculer {
    ...
    /**
     * Dummy function that enforces type safety for `ActionSchema` definitions so that
     * you can use typed `ctx.params` inferred from the action's `params` property.
     */
    function defineAction<Schema extends readonly ValidatorSchema>(schema: ActionSchema<Schema>): ActionSchema<Schema>;

    /**
     * Dummy function that enforces type safety for `ServiceEvent` definitions so that
     * you can use typed `ctx.params` inferred from the action's `params` property.
     */
