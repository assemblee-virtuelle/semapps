...
async function checkRights(askedRights, resultRights, ctx, resourceUri, resourceAclUri, uaSearchParam, graphName, isContainerDefault) {
...
module.exports = {
  ...
  action: {
    ...
    params: {
      ...
      rights: { type: 'object', optional: true, strict: true, props: {
