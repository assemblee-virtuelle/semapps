 ...
 * This is necessary so that we can store the whole credential including thee proof
 * in a single resource. Otherwise, the proof is a blank node graph which we can't handle.
 */
const noGraphCredentialContext = {
  '@protected': true,
  ...
  name: 'https://schema.org/name' as const,
